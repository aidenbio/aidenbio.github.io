...
<head>
  ...
  <title>Panini | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Panini</h1>
    ...
    <span data-tooltip title="This is an external library." class="docs-lib label"><a href="https://github.com/foundation/panini" target="_blank">Library</a></span>
    <p class="docs-description lead">A flat file compiler that powers our prototyping template. Create pages with consistent layouts and reusable partials with ease.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="t_ekdBMj4cc"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=t_ekdBMj4cc"></a>
      </div>
    </div>
...
<p>Panini is a flat file compiler that uses the concepts of templates, pages, and partials&mdash;powered by the <a href="https://handlebarsjs.com/">Handlebars</a> templating language&mdash;to streamline the process of creating static prototypes.</p>
<p>Our <a href="starter-projects.html">prototyping template</a> uses Panini, along with a host of other tools for processing Sass, JavaScript, and images, to make creating static prototypes easy. It&#39;s already been configured to utilize all of the features below, but if you want to learn the specifics of how to configure the library, head over to the <a href="https://github.com/foundation/panini">Panini GitHub page</a>.</p>
<hr>
...
<p>In the prototyping template, these finished files are compiled into a standalone folder called <code>dist</code> (short for &quot;distribution&quot;), which also includes your processed CSS, JavaScript, and images. This folder can easily be uploaded to any web server, or Notable&#39;s <a href="https://zurb.com/notable/features/hosted">Hosted Prototypes</a> service.</p>
<hr>
...
<hr>
<h2 id="helpers" class="docs-heading" data-magellan-target="helpers">Helpers<a class="docs-heading-icon" href="#helpers"></a></h2><p>Helpers are special functions that manipulate content on the page. In addition to <a href="https://handlebarsjs.com/builtin_helpers.html">Handlebars&#39;s built-in helpers</a>, Panini includes a few custom helpers and you can add your own.</p>
...
<div class="docs-code" data-docs-code><pre><code class="handlebars"><span class="hljs-template-tag">{{#<span class="hljs-name">ifequal</span> foo bar}}</span><span class="xml">
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>foo and bar are not equal}}  
</span><span class="hljs-template-tag">{{/<span class="hljs-name">ifequal</span>}}</span></code></pre></div><h3 id="ifpage" class="docs-heading">ifpage<a class="docs-heading-icon" href="#ifpage"></a></h3><p>Displays the HTML inside the helper only on specific pages. In the below example, the HTML inside the helper will only show up on the <code>index.html</code> page.</p>
<div class="docs-code" data-docs-code><pre><code class="handlebars"><span class="hljs-template-tag">{{#<span class="hljs-name">ifpage</span> 'index'}}</span><span class="xml">
...
</span><span class="hljs-template-tag">{{/<span class="hljs-name">ifpage</span>}}</span></code></pre></div><p>You can also check for multiple pages. If <em>any</em> name in the list matches the current page, the HTML will appear.</p>
<div class="docs-code" data-docs-code><pre><code class="handlebars"><span class="hljs-template-tag">{{#<span class="hljs-name">ifpage</span> 'index' 'about'}}</span><span class="xml">
...
</span><span class="hljs-template-tag">{{/<span class="hljs-name">unlesspage</span>}}</span></code></pre></div><h3 id="repeat" class="docs-heading">repeat<a class="docs-heading-icon" href="#repeat"></a></h3><p>Repeats the content inside of it <code>n</code> number of times. Use this to easily print lots of duplicate HTML in a prototype.</p>
...
<div class="docs-code" data-docs-code><pre><code class="handlebars"><span class="hljs-template-tag">{{#<span class="hljs-name">markdown</span>}}</span><span class="xml">
# Heading 1
...
</span><span class="hljs-template-tag">{{/<span class="hljs-name">markdown</span>}}</span></code></pre></div><h3 id="custom-helpers" class="docs-heading">Custom Helpers<a class="docs-heading-icon" href="#custom-helpers"></a></h3><p>If you don&#39;t see the right helper, you can write your own. Add a javascript file to &#39;src/helpers&#39;, add <code>helpers: &#39;src/helpers&#39;</code> to the Panini process in your gulpfile.babel.js, restart npm, then call it in your templates.</p>
...
<p>To add variables to a specific page only, add it at the top of the page&#39;s HTML as a <a href="https://jekyllrb.com/docs/frontmatter/">Front Matter</a> block. Let&#39;s say the below content is inside <code>src/pages/index.html</code>.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Panini</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/panini.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/panini/issues" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
