...
<head>
  ...
  <title>Global Styles | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Global Styles</h1>
    ...
    <p class="docs-description lead">Our global CSS includes helpful resets to ensure consistent styling across browsers.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="nEgHk2wmMjU"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=nEgHk2wmMjU"></a>
      </div>
    </div>
...
<hr>
<h2 id="colors" class="docs-heading" data-magellan-target="colors">Colors<a class="docs-heading-icon" href="#colors"></a></h2><p>Foundation has an accessible default color palette. The primary color is used for interactive elements, such as links and buttons. The secondary, success, warning, and alert colors are used to give more context to UI elements and actions.</p>
...
<hr>
<h3 id="changing-the-color-palette" class="docs-heading">Changing the Color Palette<a class="docs-heading-icon" href="#changing-the-color-palette"></a></h3><p>If you&#39;re using the Sass version of Foundation, you can easily change the color palette by editing the variables in your settings file.</p>
<p>The semantic colors (primary, secondary, success, warning, and alert) can be changed in the <code>$foundation-palette</code> map. The keys in this map are referenced by various settings to style components and output alternate class names.</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-variable">$foundation-palette</span>: (
  primary: <span class="hljs-number">#1779ba</span>,
  secondary: <span class="hljs-number">#767676</span>,
  success: <span class="hljs-number">#3adb76</span>,
  warning: <span class="hljs-number">#ffae00</span>,
  alert: <span class="hljs-number">#cc4b37</span>,
...
<p>The named colors (white, light gray, medium gray, dark gray, and black) can be changed in their respective variables</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-variable">$light-gray</span>: <span class="hljs-number">#e6e6e6</span>;
<span class="hljs-variable">$medium-gray</span>: <span class="hljs-number">#cacaca</span>;
<span class="hljs-variable">$dark-gray</span>: <span class="hljs-number">#8a8a8a</span>;
<span class="hljs-variable">$black</span>: <span class="hljs-number">#0a0a0a</span>;
<span class="hljs-variable">$white</span>: <span class="hljs-number">#fefefe</span>;</code></pre></div><p>The line <code>@include add-foundation-colors;</code> in your settings file allows you to use the following Sass variables to reference <em>default colors</em> from the palette:</p>
<ul>
<li><code>$primary-color</code></li>
<li><code>$secondary-color</code></li>
<li><code>$success-color</code></li>
<li><code>$warning-color</code></li>
<li><code>$alert-color</code></li>
</ul>
<p>You can also use Foundation&#39;s <code>get-color()</code> function to reference <em>any color</em> from the palette. This function gives you access to custom colors you&#39;ve added to the palette.</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-comment">// Create a variable for my custom color.</span>
<span class="hljs-variable">$custom-color</span>: get-color(custom);</code></pre></div>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>100%</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>rem-calc(1200)</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1.5</code></td>
  ...
  alert: #cc4b37<br>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>#e6e6e6</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>#cacaca</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>#8a8a8a</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>#0a0a0a</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>#fefefe</code></td>
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>&#x27;Helvetica Neue&#x27;, Helvetica, Roboto, Arial, sans-serif</code></td>
      ...
      <tr>
        <td class="name"><code>$global-position</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1rem</code></td>
        <td><p>Global value used for positioning on components.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$global-weight-normal</code></td>
        <td>Keyword or  Number</td>
        <td class="zf-docs-type-keyword | number"><code>normal</code></td>
      ...
      <tr>
        ...
        <td>Keyword or  Number</td>
        <td class="zf-docs-type-keyword | number"><code>bold</code></td>
      ...
      <tr>
        <td class="name"><code>$global-menu-padding</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0.7rem 1rem</code></td>
        <td><p>Global value used for all menu styles. Can be overwritten at individual menu component level.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$global-menu-nested-margin</code></td>
        <td></td>
        <td class="zf-docs-type-"><code>1rem</code></td>
        <td><p>Global value used for all menu styles. Nested margin for submenu.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$global-text-direction</code></td>
        <td>Keyword</td>
        <td class="zf-docs-type-keyword"><code>ltr</code></td>
      ...
      <tr>
        <td class="name"><code>$global-prototype-breakpoints</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>false</code></td>
        <td><p>Enabled responsive breakpoints for prototypes if applicable</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$global-button-cursor</code></td>
        <td>Keyword</td>
        <td class="zf-docs-type-keyword"><code>auto</code></td>
        <td><p>Button cursor&#39;s value, <code>auto</code> by default</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$global-color-pick-contrast-tolerance</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0</code></td>
        <td><p>Global tolerance for color pick contrast.</p>
</td>
      </tr>
    </table>
  </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Global Styles</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/global.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BGlobal%20Styles%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
