...
<head>
  ...
  <title>Pagination | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="9gcGADHzz9o"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=9gcGADHzz9o"></a>
      </div>
    </div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/BRxVmB?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">nav</span> <span class="hljs-attr">aria-label</span>=<span class="hljs-string">"Pagination"</span>&gt;</span>
...
<div class="docs-code-live"><nav aria-label="Pagination">
  <ul class="pagination">
...
<p>
  <a class="" data-open-video="7:20"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/dWKYZb?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">nav</span> <span class="hljs-attr">aria-label</span>=<span class="hljs-string">"Pagination"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"pagination text-center"</span>&gt;</span>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>rem-calc(3 10)</code></td>
      ...
      <tr>
        ...
        <td><p>If <code>false</code>, don&#39;t display page number links on mobile, only next/previous links
and optionally current page number.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$pagination-mobile-current-item</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>false</code></td>
        <td><p>If <code>true</code>, display the current page number on mobile even if <code>$pagination-mobile-items</code> is set to <code>false</code>.
This parameter will only override the visibility setting of the current item for <code>$pagination-mobile-items: false;</code>,
it will not affect the current page number visibility when <code>$pagination-mobile-items</code> is set to <code>true</code>.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$pagination-arrow-previous</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>&#x27;\00AB&#x27;</code></td>
        <td><p>Content for the previous arrow when <code>$pagination-arrows</code> is <code>true</code></p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$pagination-arrow-next</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>&#x27;\00BB&#x27;</code></td>
        <td><p>Content for the next arrow when <code>$pagination-arrows</code> is <code>true</code></p>
</td>
      </tr>
    </table>
  </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Pagination</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/pagination.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BPagination%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
