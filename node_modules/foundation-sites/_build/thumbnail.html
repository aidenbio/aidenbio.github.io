...
<head>
  ...
  <title>Thumbnail | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Thumbnail</h1>
    ...
    <p class="docs-description lead">If you're going to use an image as an anchor, we've got you covered. All you gotta do is add one class to your image and voilà!</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="BOtW8oacFZk"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=BOtW8oacFZk"></a>
      </div>
    </div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/EmLexY?editors=1100" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"thumbnail"</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"assets/img/thumbnail/01.jpg"</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">"Photo of Uranus."</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"thumbnail"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"assets/img/thumbnail/02.jpg"</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">"Photo of Neptune."</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"thumbnail"</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"assets/img/thumbnail/03.jpg"</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">"Photo of Pluto."</span>&gt;</span></code></pre></div><div class="grid-x grid-margin-x">
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Border</td>
        <td class="zf-docs-type-border"><code>4px solid $white</code></td>
      ...
      <tr>
        ...
        <td>Length</td>
        <td class="zf-docs-type-length"><code>$global-margin</code></td>
      ...
      <tr>
        ...
        <td>Shadow</td>
        <td class="zf-docs-type-shadow"><code>0 0 0 1px rgba($black, 0.2)</code></td>
      ...
      <tr>
        ...
        <td>Shadow</td>
        <td class="zf-docs-type-shadow"><code>0 0 6px 1px rgba($primary-color, 0.5)</code></td>
        <td><p>Box shadow under thumbnail images.</p>
</td>
      </tr>
      <tr>
        ...
        <td>Transition</td>
        <td class="zf-docs-type-transition"><code>box-shadow 200ms ease-out</code></td>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Thumbnail</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/thumbnail.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BThumbnail%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
