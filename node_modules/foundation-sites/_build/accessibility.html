...
<head>
  ...
  <title>Accessibility | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Accessibility</h1>
    ...
    <p class="docs-description lead">Foundation for Sites is a fully-accessible framework. Here are some general guidelines to keep in mind as you make your pages accessible.</p>
...
Blind users consume the web by reading it using a <a href="https://en.wikipedia.org/wiki/Screen_reader">screen reader</a>. Screen readers read the content of a web page out loud, or write it out as Braille, using certain cues from the HTML to infer meaning.</p>
...
<li><a href="https://webaim.org/">WebAIM certification and training</a></li>
...
<li><a href="https://wave.webaim.org">WAVE Chrome plugin - free accessibility checker</a></li>
<li><a href="https://webaim.org/resources/contrastchecker">Color Contrast Checker</a></li>
<li><a href="https://www.chromevox.com">ChromeVox screen reader plugin for Chrome</a></li>
<li><a href="https://www.freedomscientific.com/Products/Blindness/Jaws">JAWS screen reader for Windows</a></li>
<li><a href="https://www.nvaccess.org/download/">NVDA screen reader for Windows - Free</a></li>
</ul>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Accessibility</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/accessibility.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BAccessibility%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
