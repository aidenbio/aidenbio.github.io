...
<head>
  ...
  <title>Dropdown | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="0F68zptD_nQ"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=0F68zptD_nQ"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:47"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/NjzByp?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/YVvjvz?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<hr>
<h2 id="explicit-positioning" class="docs-heading" data-magellan-target="explicit-positioning">Explicit Positioning<a class="docs-heading-icon" href="#explicit-positioning"></a></h2><div class="callout primary">
...
<h4 id="top-and-bottom-positioned" class="docs-heading">Top and Bottom positioned<a class="docs-heading-icon" href="#top-and-bottom-positioned"></a></h4><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-comment">&lt;!-- Bottom Left --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-bottom-left"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"bottom"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"left"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-bottom-left"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Bottom Center --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-bottom-center"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"bottom"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"center"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-bottom-center"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Bottom Right --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-bottom-right"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"bottom"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"right"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-bottom-right"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Top Left --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-top-left"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"top"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"left"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-top-left"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Top Center --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-top-center"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"top"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"center"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-top-center"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Top Right --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-top-right"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"top"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"right"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-top-right"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- My dropdown content in here --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><div class="grid-container">
...
<h4 id="left-and-right-positioned" class="docs-heading">Left and Right Positioned<a class="docs-heading-icon" href="#left-and-right-positioned"></a></h4><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-comment">&lt;!-- Right Top --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-right-top"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"right"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"top"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-right-top"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Left Top --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-left-top"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"left"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"top"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-left-top"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Right Center --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-right-center"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"right"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"center"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-right-center"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Left Center --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-left-center"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"left"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"center"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-left-center"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Right Bottom --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-right-bottom"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"right"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"bottom"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-right-bottom"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Left Bottom --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-dropdown-left-bottom"</span>&gt;</span>Toggle Dropdown<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown-pane"</span> <span class="hljs-attr">data-position</span>=<span class="hljs-string">"left"</span> <span class="hljs-attr">data-alignment</span>=<span class="hljs-string">"bottom"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-dropdown-left-bottom"</span> <span class="hljs-attr">data-dropdown</span> <span class="hljs-attr">data-auto-focus</span>=<span class="hljs-string">"true"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><div class="grid-container">
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>1rem</code></td>
        <td><p>Padding for dropdown panes.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdown-background</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$body-background</code></td>
        <td><p>Background for dropdown panes.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdown-border</code></td>
        <td>List</td>
        <td class="zf-docs-type-list"><code>1px solid $medium-gray</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>300px</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$global-radius</code></td>
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.dropdown.js</code>

          <ul>
            <li>With utility library <code>foundation.util.keyboard.js</code></li>
            <li>With utility library <code>foundation.util.box.js</code></li>
            <li>With utility library <code>foundation.util.touch.js</code></li>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td><code>data-parent-class</code></td>
        <td><code>string</code></td>
        <td><code>null</code></td>
        <td>Class that designates bounding container of Dropdown (default: window)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Position of dropdown. Can be left, right, bottom, top, or auto.</td>
      </tr>
      <tr>
        <td><code>data-alignment</code></td>
        <td><code>string</code></td>
        <td><code>auto</code></td>
        <td>Alignment of dropdown relative to anchor. Can be left, right, bottom, top, center, or auto.</td>
      </tr>
      <tr>
        <td><code>data-allow-overlap</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Allow overlap of container/window. If false, dropdown will first try to position as defined by data-position and data-alignment, but reposition if it would cause an overflow.</td>
      </tr>
      <tr>
        <td><code>data-allow-bottom-overlap</code></td>
        <td><code>boolean</code></td>
        <td><code>true</code></td>
        <td>Allow overlap of only the bottom of the container. This is the most common
behavior for dropdowns, allowing the dropdown to extend the bottom of the
screen but not otherwise influence or break out of the container.</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><code>boolean</code></td>
        <td><code>true</code></td>
        <td>If true the default action of the toggle (e.g. follow a link with href) gets executed on click. If hover option is also true the default action gets prevented on first click for mobile / touch devices and executed on second click.</td>
      </tr>
    </table>
  </section>
    ...
    <table class="docs-variable-table">
      <thead>
        ...
        <tr>
          ...
          <td>Fires to close other open dropdowns, typically when dropdown is opening</td>
        </tr>
        <tr>
        ...
        <tr>
          <td><code>hide.zf.dropdown</code></td>
          <td>Fires once the dropdown is no longer visible.</td>
        </tr>
    </table>
  </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Dropdown</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/dropdown.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BDropdown%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
