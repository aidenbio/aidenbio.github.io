...
<head>
  ...
  <meta name="description" content="Added in 6.3.0, use the Markup of the Accordion or Tabs components to create Responsive Accordion Tabs.">
  <link rel="icon" href="assets/img/icons/foundation-favicon.ico" type="image/x-icon">
  <title>Responsive Accordion Tabs | Foundation for Sites 6 Docs</title>
                  ...
                  <li class="accordion-item is-active" data-accordion-item>
                    ...
                    <div class="accordion-content is-active" data-tab-content>
                      <ul class="docs-nav-subcategory">
                        ...
                        <li class="current"><a href="responsive-accordion-tabs.html">Responsive Accordion Tabs<span class="label">JS</span></a></li>
                      </ul>
                    </div>
                  </li>
...
<article class="docs-component" id="docs-responsive-accordion-tabs">
...
<div>
<header>
  <h1 class="docs-page-title">Responsive Accordion Tabs</h1>

    <span data-tooltip title="Requires a JavaScript library." class="docs-js label">JavaScript</span>
    <p class="docs-description lead">Added in 6.3.0, use the Markup of the Accordion or Tabs components to create Responsive Accordion Tabs.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="FKzzaWR6j2M"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=FKzzaWR6j2M"></a>
      </div>
    </div>
...
<h2 id="basics" class="docs-heading" data-magellan-target="basics">Basics<a class="docs-heading-icon" href="#basics"></a></h2><p>Either the <a href="accordion.html">Accordion Markup</a> or the <a href="tabs.html">Tabs Markup</a> can be used to responsively switch between the two components at different breakpoints.</p>
...
<h4 id="accordion-html-markup" class="docs-heading">Accordion HTML Markup<a class="docs-heading-icon" href="#accordion-html-markup"></a></h4><p>
  <a class="" data-open-video="0:35"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/eWKPqE?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion"</span> <span class="hljs-attr">data-responsive-accordion-tabs</span>=<span class="hljs-string">"accordion medium-tabs large-accordion"</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><div class="secondary callout">
...
<h4 id="tabs-html-markup" class="docs-heading">Tabs HTML Markup<a class="docs-heading-icon" href="#tabs-html-markup"></a></h4><p>
  <a class="" data-open-video="2:39"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/mmKQVN?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs"</span> <span class="hljs-attr">data-responsive-accordion-tabs</span>=<span class="hljs-string">"tabs medium-accordion large-tabs"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-tabs"</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-content"</span> <span class="hljs-attr">data-tabs-content</span>=<span class="hljs-string">"example-tabs"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><div class="secondary callout">
...
<hr>
<h2 id="plugin-options" class="docs-heading" data-magellan-target="plugin-options">Plugin Options<a class="docs-heading-icon" href="#plugin-options"></a></h2><p>Plugin options can be set as individual data attributes, one combined data-options attribute, or as an object passed to the plugin&#39;s constructor. <a href="javascript.html#initializing">Learn more about how JavaScript plugins are initialized.</a><br></p>
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.responsiveAccordionTabs.js</code>

          <ul>
            <li>With utility library <code>foundation.util.motion.js</code></li>
            <li>With utility library <code>foundation.accordion.js</code></li>
            <li>With utility library <code>foundation.tabs.js</code></li>
          </ul>
  ...
  <section>
    <h3 id="js-class" class="docs-heading">Foundation.ResponsiveAccordionTabs<a class="docs-heading-icon" href="#js-class"></a></h3>

    <p>Creates a new instance of a responsive accordion tabs.</p>


    <div class="docs-code"><pre><code><span class="hljs-keyword">var</span> elem = <span class="hljs-keyword">new</span> Foundation.ResponsiveAccordionTabs(element, options);</code></pre></div>

      <p><strong>Fires these events:</strong>
        ResponsiveAccordionTabs#event:init
      </p>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>jQuery</td>
        <td>jQuery object to make into Responsive Accordion Tabs.</td>
      </tr>
      <tr>
  ...
  <section>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'open'</span>, target);</code></pre>
      </div>

      <p>Opens the plugin pane defined by <code>target</code>.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td>jQuery</td>
          <td>jQuery object or string of the id of the pane to open.</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'close'</span>, target);</code></pre>
      </div>

      <p>Closes the plugin pane defined by <code>target</code>. Not availaible for Tabs.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>target</code></td>
          <td>jQuery</td>
          <td>jQuery object or string of the id of the pane to close.</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <p>Toggles the plugin pane defined by <code>target</code>. Not availaible for Tabs.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>target</code></td>
          <td>jQuery</td>
          <td>jQuery object or string of the id of the pane to toggle.</td>
        </tr>
      </table>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Responsive Accordion Tabs</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/responsive-accordion-tabs.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BResponsive%20Accordion%20Tabs%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
