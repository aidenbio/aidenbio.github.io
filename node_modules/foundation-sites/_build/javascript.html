...
<head>
  ...
  <title>JavaScript | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">JavaScript</h1>
    ...
    <p class="docs-description lead">Our JavaScript is easy to set up and only requires jQuery to get going.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="Mf5ZZfKTe-I"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=Mf5ZZfKTe-I"></a>
      </div>
    </div>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-comment">&lt;!-- jQuery must be imported before Foundation --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/jquery.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-comment">&lt;!-- this will include every plugin and utility required by Foundation --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/foundation.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre></div><h3 id="import-in-html" class="docs-heading">Import in HTML<a class="docs-heading-icon" href="#import-in-html"></a></h3><p>You can import in your HTML the complete Foundation library <code>foundation.min.js</code> like above, but also each plugin individually.</p>
...
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/jquery.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span> <span class="hljs-comment">&lt;!-- Required --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/foundation.core.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>  <span class="hljs-comment">&lt;!-- Required --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/foundation.util.mediaQuery.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/foundation.tabs.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/foundation.accordion.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre></div><p>Know that they all require <code>foundation.core.js</code> to be loaded <em>first</em>. Some plugins also require specific utility libraries that ship with Foundation&mdash;refer to a plugin&#39;s documentation to find out which plugins require what, and see the <a href="javascript-utilities.html">JavaScript Utilities</a> page for more information.</p>
...
<h3 id="import-in-javascript" class="docs-heading">Import in JavaScript<a class="docs-heading-icon" href="#import-in-javascript"></a></h3><p>By default, Foundation is exported as <a href="http://bob.yexley.net/umd-javascript-that-runs-anywhere/">UMD modules</a>. This means that Foundation and its plugins can be imported and used in any JavaScript environment.</p>
<p>For example with <a href="https://github.com/lukehoban/es6features#readme">ES6</a> (the ESM format):</p>
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-keyword">import</span> Foundation <span class="hljs-keyword">from</span> <span class="hljs-string">'foundation-sites'</span>;
<span class="hljs-keyword">const</span> $dropdown = <span class="hljs-keyword">new</span> Foundation.Dropdown($(<span class="hljs-string">'#mydropdown'</span>));
<span class="hljs-comment">// Or</span>
<span class="hljs-keyword">import</span> { Dropdown } <span class="hljs-keyword">from</span> <span class="hljs-string">'foundation-sites'</span>;
<span class="hljs-keyword">const</span> $dropdown = <span class="hljs-keyword">new</span> Dropdown($(<span class="hljs-string">'#mydropdown'</span>));</code></pre></div><p>With <a href="https://requirejs.org/">RequireJs</a> (the AMD format):</p>
<div class="docs-code" data-docs-code><pre><code class="js">define([<span class="hljs-string">'foundation'</span>], <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">Foundation</span>) </span>{
  <span class="hljs-keyword">var</span> $dropdown = <span class="hljs-keyword">new</span> Foundation.Dropdown($(<span class="hljs-string">'#mydropdown'</span>));
});</code></pre></div><p>With <a href="https://www.safaribooksonline.com/library/view/learning-javascript-design/9781449334840/ch11s03.html">Node.js</a> (the CommonJs format):</p>
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-keyword">var</span> Foundation = <span class="hljs-built_in">require</span>(<span class="hljs-string">'foundation-sites'</span>);
<span class="hljs-keyword">var</span> $dropdown = <span class="hljs-keyword">new</span> Dropdown($(<span class="hljs-string">'#mydropdown'</span>));</code></pre></div><h4 id="available-formats" class="docs-heading">Available formats<a class="docs-heading-icon" href="#available-formats"></a></h4><p>Foundation is provided in bundles of various module formats so you can pick the one that matches the best your needs. If you don&#39;t know these terms yet, take a look at this <a href="https://www.jvandemo.com/a-10-minute-primer-to-javascript-modules-module-formats-module-loaders-and-module-bundlers/">10-minute introduction to module formats in JavaScript</a>. You will find in the <code>dist/js</code> folder the following bundles:</p>
<ul>
<li><p><code>foundation.js</code> <span class="label secondary">UMD</span> <span class="label">Default</span><br>
Compatible with most environments and tools (AMD, CJS, ESM...). It works almost everywhere by checking the module format of your environments and then using it, which makes the bundle a little heavier.</p>
</li>
<li><p><code>foundation.cjs.js</code> <span class="label secondary">CommonJS</span><br>
Dedicated to Node.js and older bundlers like Browserify or Webpack v1.</p>
</li>
<li><p><code>foundation.esm.js</code> <span class="label secondary">ES6 Modules</span>  (<code>module</code> in <code>package.json</code>)<br>
Everything is transpiled to ES5 but the modules. Dedicated to modern bundlers, like Webpack 2+ or Rollup. They will automatically use this bundle and parse the ES6 modules to remove the unused code (see <a href="#tree-shaking">tree shaking</a> below).</p>
</li>
<li><p><code>foundation.es6.js</code> <span class="label secondary">ES6</span> (<code>esnext</code> in <code>package.json</code>)<br>
Unlike the other bundles, this bundle is not transpiled. It contains all the Foundation sources in ES6 in a single file. Use it if you want to manually transpile it for your own targets.</p>
</li>
</ul>
<h4 id="tree-shaking" class="docs-heading">Tree Shaking<a class="docs-heading-icon" href="#tree-shaking"></a></h4><p>Many bundlers like Webpack, Rollup or Parcel support tree shaking. It consists of the removing the unused code parts from your codebase or your dependencies. Take a look at these articles to know how it works and how to enable it: <a href="https://www.engineyard.com/blog/tree-shaking">How To Clean Up Your JavaScript Build With Tree Shaking</a>, <a href="https://advancedweb.hu/2017/02/07/treeshaking/">Why Webpack 2&#39;s Tree Shaking is not as effective as you think</a> and <a href="https://developers.google.com/web/fundamentals/performance/optimizing-javascript/tree-shaking/">Reduce JavaScript Payloads with Tree Shaking</a>.</p>
<p>As tree shaking is only available in ES6, we recommend to import plugins like the following:</p>
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-comment">// Only Dropdown and DropdownMenu will be included in your application.</span>
<span class="hljs-keyword">import</span> { Dropdown, DropdownMenu } <span class="hljs-keyword">from</span> <span class="hljs-string">'foundation-sites'</span>;</code></pre></div><p>Sadly, the &quot;static analysis&quot; promised by these bundlers to detect unused code in dependencies does not always work. Depending on your build environment, you may have to manually import the Foundation plugins to make it work correctly:</p>
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-comment">// /!\ Don't use this if tree shaking works with standard named imports.</span>
<span class="hljs-comment">// Only Dropdown and DropdownMenu will be included in your application.</span>
<span class="hljs-keyword">import</span> { Dropdown } <span class="hljs-keyword">from</span> <span class="hljs-string">'foundation-sites/js/foundation.dropdown'</span>;
<span class="hljs-keyword">import</span> { DropdownMenu } <span class="hljs-keyword">from</span> <span class="hljs-string">'foundation-sites/js/foundation.dropdownMenu'</span>;</code></pre></div><hr>
...
<div class="docs-code" data-docs-code><pre><code class="js">$(<span class="hljs-built_in">document</span>).foundation();</code></pre></div><p>You can also selectively initialize plugins by calling the <code>.foundation();</code> method on one or more elements with a plugin.</p>
...
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-keyword">var</span> options = {<span class="hljs-attr">multiExpand</span>: <span class="hljs-literal">true</span>, <span class="hljs-attr">allowAllClosed</span>: <span class="hljs-literal">false</span>};
...
});</code></pre></div><p>Plugins that are already initialized will be ignored. However for performance reasons, we recommend calling <code>.foundation()</code> only on the DOM nodes that changed.</p>
<hr>
...
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-keyword">var</span> $accordion = <span class="hljs-keyword">new</span> Foundation.Accordion($(<span class="hljs-string">'#accordion'</span>), {
  <span class="hljs-attr">slideSpeed</span>: <span class="hljs-number">500</span>,
  <span class="hljs-attr">multiExpand</span>: <span class="hljs-literal">true</span>
...
$(<span class="hljs-string">'.tooltip'</span>).foundation(<span class="hljs-string">'_destroy'</span>); <span class="hljs-comment">//will destroy all Tooltips on the page.</span>
</code></pre></div><p>You can use any jQuery selector you like, and if the selector encompasses multiple plugins, they will all have the same the chosen method invoked. You pass arguments just like you would any in other JavaScript <code>function(comma, delimited, so, easy)</code>. We did make an effort to reduce the number of public methods that require arguments, but check the plugin&#39;s page to see if it requires additional information.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">JavaScript</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/javascript.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BJavaScript%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
