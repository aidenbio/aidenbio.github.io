...
<head>
  ...
  <title>Tabs | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="8FtJRXPF5Cs"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=8FtJRXPF5Cs"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:50"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/VbdGKj?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<hr>
<h2 id="vertical-tabs" class="docs-heading" data-magellan-target="vertical-tabs">Vertical Tabs<a class="docs-heading-icon" href="#vertical-tabs"></a></h2><p>Add the <code>.vertical</code> class to a tabstrip and tab contents to stack tabs vertically. You can also remove the <code>.grid-margin-x</code> class from the wrapping div to make them sit side-by-side.</p>
<p>
  <a class="" data-open-video="3:46"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/eWKLdX?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-container"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell medium-3"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical tabs"</span> <span class="hljs-attr">data-tabs</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-tabs"</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell medium-9"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-content vertical"</span> <span class="hljs-attr">data-tabs-content</span>=<span class="hljs-string">"example-tabs"</span>&gt;</span>
...
<div class="docs-code-live"><div class="grid-container">
  <div class="grid-x">
...
<h2 id="collapsing-tabs" class="docs-heading" data-magellan-target="collapsing-tabs">Collapsing Tabs<a class="docs-heading-icon" href="#collapsing-tabs"></a></h2><p>Add the attribute <code>data-active-collapse=&quot;true&quot;</code> to a tabstrip to collapse active tabs.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/LyrJQZ?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs"</span> <span class="hljs-attr">data-active-collapse</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-tabs</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"collapsing-tabs"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title is-active"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel1c"</span> <span class="hljs-attr">aria-selected</span>=<span class="hljs-string">"true"</span>&gt;</span>Tab 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel2c"</span>&gt;</span>Tab 2<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel3c"</span>&gt;</span>Tab 3<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel4c"</span>&gt;</span>Tab 4<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-content"</span> <span class="hljs-attr">data-tabs-content</span>=<span class="hljs-string">"collapsing-tabs"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel is-active"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel1c"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel2c"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel3c"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel4c"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><ul class="tabs" data-active-collapse="true" data-tabs id="collapsing-tabs">
...
<p>
  <a class="" data-open-video="5:14"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs"</span> <span class="hljs-attr">data-deep-link</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-update-history</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge-delay</span>=<span class="hljs-string">"500"</span> <span class="hljs-attr">data-tabs</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplinked-tabs"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title is-active"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel1d"</span> <span class="hljs-attr">aria-selected</span>=<span class="hljs-string">"true"</span>&gt;</span>Tab 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel2d"</span>&gt;</span>Tab 2<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel3d"</span>&gt;</span>Tab 3<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-title"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#panel4d"</span>&gt;</span>Tab 4<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span>

<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-content"</span> <span class="hljs-attr">data-tabs-content</span>=<span class="hljs-string">"deeplinked-tabs"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel is-active"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel1d"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel2d"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Vivamus hendrerit arcu sed erat molestie vehicula. Sed auctor neque eu tellus rhoncus ut eleifend nibh porttitor. Ut in nulla enim. Phasellus molestie magna non est bibendum non venenatis nisl tempor. Suspendisse dictum feugiat nisl ut dapibus.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel3d"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"thumbnail"</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"assets/img/generic/rectangle-3.jpg"</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-panel"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"panel4d"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><ul class="tabs" data-deep-link="true" data-update-history="true" data-deep-link-smudge="true" data-deep-link-smudge-delay="500" data-tabs id="deeplinked-tabs">
...
</div></div><p>For example, <a target="_blank" href="#panel3d">https://example.com/#panel3d</a> will open the third tab panel at page load. This example will open a new browser tab and scroll you to the open tab.</p>
<p>When linking directly to a tab panel, it might not be obvious that the content appears within a tab panel. An additional attribute <code>data-deep-link-smudge</code> rolls the page up slightly after deep linking (to a horizontal tabset) so that the tabstrip is at the top of the viewport.</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs"</span> <span class="hljs-attr">data-deep-link</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge-delay</span>=<span class="hljs-string">"600"</span> <span class="hljs-attr">data-tabs</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplinked-tabs-with-smudge"</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><ul class="tabs" data-deep-link="true" data-deep-link-smudge="true" data-deep-link-smudge-delay="600" data-tabs id="deeplinked-tabs-with-smudge"></div>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0</code></td>
      ...
      <tr>
        <td class="name"><code>$tab-color</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$primary-color</code></td>
        <td><p>Font color of tab item.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$tab-active-color</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$primary-color</code></td>
        <td><p>Active font color of tab item.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td></td>
        <td class="zf-docs-type-"><code>$white</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1.25rem 1.5rem</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$body-font-color</code></td>
      ...
      <tr>
        ...
        <td class="zf-docs-type-number | list"><code>1rem</code></td>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.tabs.js</code>

          <ul>
            <li>With utility library <code>foundation.util.keyboard.js</code></li>
            <li>With utility library <code>foundation.util.imageLoader.js</code></li>
          </ul>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Link the location hash to the active pane.
Set the location hash when the active pane changes, and open the corresponding pane when the location changes.</td>
      </tr>
      <tr>
        <td><code>data-deep-link-smudge</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>If `deepLink` is enabled, adjust the deep link scroll to make sure the top of the tab panel is visible</td>
      </tr>
      <tr>
        <td><code>data-deep-link-smudge-delay</code></td>
        <td><code>number</code></td>
        <td><code>300</code></td>
        <td>If `deepLinkSmudge` is enabled, animation time (ms) for the deep link adjustment</td>
      </tr>
      <tr>
        <td><code>data-update-history</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>If `deepLink` is enabled, update the browser history with the open tab</td>
      </tr>
      <tr>
        <td><code>data-auto-focus</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Allows the window to scroll to content of active pane on load.
Not recommended if more than one tab panel per page.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-active-collapse</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Allows active tabs to collapse when clicked.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-link-active-class</code></td>
        <td><code>string</code></td>
        <td><code>is-active</code></td>
        <td>Class applied to the active `li` in tab link list.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-panel-active-class</code></td>
        <td><code>string</code></td>
        <td><code>is-active</code></td>
        <td>Class applied to the active content container.</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      <thead>
        ...
        <tr>
          <td><code>deeplink.zf.tabs</code></td>
          <td>Fires when the plugin has deeplinked at pageload</td>
        </tr>
        <tr>
        ...
        <tr>
          <td><code>collapse.zf.tabs</code></td>
          <td>Fires when the plugin has successfully collapsed tabs.</td>
        </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_handleTabChange'</span>, $target, historyHandled);</code></pre>
      </div>

      <p>Opens the tab <code>$targetContent</code> defined by <code>$target</code>. Collapses active tab.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>historyHandled</code></td>
          <td>boolean</td>
          <td>browser has already handled a history update</td>
        </tr>
      </table>
    ...
    <section>
      <h4 id="_opentab" class="docs-heading">_openTab<a class="docs-heading-icon" href="#_opentab"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_openTab'</span>, $target);</code></pre>
      </div>
    ...
    <section>
      <h4 id="_collapsetab" class="docs-heading">_collapseTab<a class="docs-heading-icon" href="#_collapsetab"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_collapseTab'</span>, $target);</code></pre>
      </div>

      <p>Collapses <code>$targetContent</code> defined by <code>$target</code>.</p>
    ...
    <section>
      <h4 id="_collapse" class="docs-heading">_collapse<a class="docs-heading-icon" href="#_collapse"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_collapse'</span>);</code></pre>
      </div>

      <p>Collapses the active Tab.</p>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'selectTab'</span>, elem, historyHandled);</code></pre>
      </div>
    ...
    <section>
      ...
      <p>Destroys an instance of tabs.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Tabs</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/tabs.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BTabs%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
