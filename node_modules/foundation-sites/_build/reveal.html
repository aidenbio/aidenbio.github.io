...
<head>
  ...
  <title>Reveal | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="vnT3bp07iHI"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=vnT3bp07iHI"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:36"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/RVyBPw?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-open</span>=<span class="hljs-string">"exampleModal1"</span>&gt;</span>Click me for a modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><p><button class="button" data-open="exampleModal1">Click me for a modal</button></p></div><p>You&#39;ll also need a way to <em>close</em> the modal from inside. By default, modals will close if clicked outside of, or if the <kbd>esc</kbd> key is pressed. However, you&#39;ll generally also want to add your own click trigger. Add the attribute <code>data-close</code> to any element within the modal to add one.</p>
...
<h2 id="sizing" class="docs-heading" data-magellan-target="sizing">Sizing<a class="docs-heading-icon" href="#sizing"></a></h2><p>On small screens, a modal is always 100% of the width of the screen. On medium-sized screens and larger, the width changes to 600px (see the <code>$reveal-width</code> setting).</p>
...
<p>
  <a class="" data-open-video="3:38"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/eWKQer?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><p><button class="button" data-toggle="exampleModal5" aria-controls="exampleModal5">Click me for a tiny modal</button></p>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/PmaxBz?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-open</span>=<span class="hljs-string">"exampleModal2"</span>&gt;</span>Click me for a modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"reveal"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleModal2"</span> <span class="hljs-attr">data-reveal</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-open</span>=<span class="hljs-string">"exampleModal3"</span>&gt;</span>Click me for another modal!<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
...
<div class="docs-code-live"><p><button class="button" data-open="exampleModal2">Click me for a modal</button></p>
...
<p>
  <a class="" data-open-video="4:58"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/mmKQQV?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"exampleModal8"</span>&gt;</span>Click me for a full-screen modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"full reveal"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleModal8"</span> <span class="hljs-attr">data-reveal</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://placekitten.com/1920/1280"</span> <span class="hljs-attr">alt</span>=<span class="hljs-string">"Introspective Cage"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"close-button"</span> <span class="hljs-attr">data-close</span> <span class="hljs-attr">aria-label</span>=<span class="hljs-string">"Close reveal"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">aria-hidden</span>=<span class="hljs-string">"true"</span>&gt;</span><span class="hljs-symbol">&amp;times;</span><span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><p><button class="button" data-toggle="exampleModal8">Click me for a full-screen modal</button></p>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/vmrQwL?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"exampleModal9"</span>&gt;</span>Click me for an overlay-lacking modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<div class="docs-code-live"><p><button class="button" data-toggle="exampleModal9">Click me for an overlay-lacking modal</button></p>
...
<h3 id="animations" class="docs-heading">Animations<a class="docs-heading-icon" href="#animations"></a></h3><p>To use animations from the Motion UI library, include the <code>data-animation-in="someAnimationIn"</code> and <code>data-animation-out="someAnimationOut"</code> attributes. If you want to adjust the speed or timing, include it the attributes like <code>data-animation-in="someAnimationIn fast"</code>.</p>
<p>
  <a class="" data-open-video="5:40"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/ZKRVeP?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"animatedModal10"</span>&gt;</span>Click me for a modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<div class="docs-code-live"><p><button class="button" data-toggle="animatedModal10">Click me for a modal</button></p>
...
<h2 id="accessibility" class="docs-heading" data-magellan-target="accessibility">Accessibility<a class="docs-heading-icon" href="#accessibility"></a></h2><p>Modals by default are accessible through the use of various ARIA attributes.  To make a modal even more accessible, designate a label to the modal by adding <code>aria-labelledby=&quot;exampleModalHeader11&quot;</code> to the container and <code>id=&quot;exampleModalHeader11&quot;</code> to the element you want to designate as the label.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/RVJEBZ?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-open</span>=<span class="hljs-string">"exampleModal11"</span>&gt;</span>Click me for a modal<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
...
<div class="docs-code-live"><p><button class="button" data-open="exampleModal11">Click me for a modal</button></p>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>600px</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$global-padding</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1px solid $medium-gray</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1005</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>rgba($black, 0.45)</code></td>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.reveal.js</code>
          ...
          <ul>
            ...
            <li>With utility library <code>foundation.util.motion.js</code></li>
          </ul>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Link the location hash to the modal.
Set the location hash when the modal is opened/closed, and open/close the modal when the location changes.</td>
      </tr>
      <tr>
        <td><code>data-update-history</code></td>
        <td><code></code></td>
        <td><code>false</code></td>
        <td>If `deepLink` is enabled, update the browser history with the open modal</td>
      </tr>
      <tr>
        <td><code>data-append-to</code></td>
        <td><code>string</code></td>
        <td><code>body</code></td>
        <td>Allows the modal to append to custom div.</td>
      </tr>
      <tr>
        <td><code>data-additional-overlay-classes</code></td>
        <td><code>string</code></td>
        <td><code>&amp;#x27;&amp;#x27;</code></td>
        <td>Allows adding additional class names to the reveal overlay.</td>
      </tr>
    </table>
  </section>
...
Closes any other modals that are currently open</td>
  ...
  <section>
    ...
    <section>
      <h4 id="_disablescroll" class="docs-heading">_disableScroll<a class="docs-heading-icon" href="#_disablescroll"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_disableScroll'</span>, scrollTop);</code></pre>
      </div>

      <p>Disables the scroll when Reveal is shown to prevent the background from shifting</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td>number</td>
          <td>Scroll to visually apply, window current scroll by default</td>
        </tr>
      </table>
    ...
    <section>
      <h4 id="_enablescroll" class="docs-heading">_enableScroll<a class="docs-heading-icon" href="#_enablescroll"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_enableScroll'</span>, scrollTop);</code></pre>
      </div>

      <p>Reenables the scroll when Reveal closes</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>scrollTop</code></td>
          <td>number</td>
          <td>Scroll to restore, html "top" property by default (as set by `_disableScroll`)</td>
        </tr>
      </table>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Reveal</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/reveal.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BReveal%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
