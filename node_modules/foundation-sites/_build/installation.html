...
<head>
  ...
  <title>Installation | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Installation</h1>
    ...
    <p class="docs-description lead">There are many ways to install Foundation, but if you're just getting started, we have a few suggestions.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="6KwsGcEHVTE"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=6KwsGcEHVTE"></a>
      </div>
    </div>
...
<h2 id="install-with-package-managers" class="docs-heading" data-magellan-target="install-with-package-managers">Install with Package Managers<a class="docs-heading-icon" href="#install-with-package-managers"></a></h2><p>Foundation is available on npm, Bower, Meteor, and Composer. The package includes all of the source Sass and JavaScript files, as well as compiled CSS and JavaScript, in uncompressed and compressed flavors.</p>
<div class="grid-x grid-margin-x">
  <div class="cell small-2 text-right">
    <a href="https://www.npmjs.com/package/foundation-sites">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-npm.svg" alt="NPM">
    </a>
  </div>
  ...
  <div class="cell small-2 text-right">
    <a href="https://www.npmjs.com/package/foundation-sites">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-pnpm.svg" alt="PNPM">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
  ...
  <div class="cell small-2 text-right">
    <a href="https://yarnpkg.com/en/package/foundation-sites">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-yarn.svg" alt="Yarn">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
  ...
  <div class="cell small-2 text-right">
    <a href="https://bower.io/search/?q=foundation-sites">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-bower.svg" alt="Bower">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
  ...
  <div class="cell small-2 text-right">
    <a href="https://rubygems.org/gems/foundation-rails">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-rubygems.svg" alt="Ruby Gems">
    </a>
  </div>
  ...
  <div class="cell small-2 text-right">
    <a href="https://atmospherejs.com/foundation/foundation-sites">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-meteor.svg" alt="Meteor">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
  ...
  <div class="cell small-2 text-right">
    <a href="https://packagist.org/packages/foundation/foundation">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-composer.svg" alt="Composer">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
  ...
  <div class="cell small-2 text-right">
    <a href="https://www.nuget.org/packages/foundation-sites/">
      <img class="docs-install-vendor-icon" src="assets/img/icons/logo-nuget.svg" alt="NuGet">
    </a>
  </div>
  <div class="cell small-10">
    <div class="docs-code">
...
<div class="docs-code" data-docs-code><pre><code class="html">├─ scss       Source Sass files. Use this folder as a load path in Sass.
├─ js         Source JavaScript files. If you're using a build system, make sure `foundation.core.js` is loaded first.
└─ dist       Compiled files:
   ├─ css        * Compiled CSS files. Includes minified and unminified files.
   ├─ js         * Concatenated JavaScript files. Includes minified and unminified files.
   └─ plugins    * Standalone JavaScript plugins.</code></pre></div><hr>
<h2 id="install-with-foundation-cli" class="docs-heading" data-magellan-target="install-with-foundation-cli">Install with Foundation CLI<a class="docs-heading-icon" href="#install-with-foundation-cli"></a></h2><p>Not a fan of GUIs? The Node-powered Foundation CLI can install the same template projects for you.</p>
<p>Install Foundation CLI:</p>
<div class="docs-code" data-docs-code><pre><code class="bash">npm install --global foundation-cli
<span class="hljs-comment"># or sudo npm install --global foundation-cli</span></code></pre></div><div class="callout info">
...
<div class="docs-code" data-docs-code><pre><code class="bash">foundation new</code></pre></div><p>After you selected &quot;Foundation for Sites&quot;, Foundation CLI will ask you which template you want to use. You can choose between:</p>
<div class="grid-x grid-margin-x">
...
<hr>
<h2 id="download" class="docs-heading" data-magellan-target="download">Download<a class="docs-heading-icon" href="#download"></a></h2><div class="grid-x grid-margin-x">
  <div class="cell small-6">
...
<span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">"stylesheet"</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/foundation-sites@6.6.3/dist/css/foundation.min.css"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha256-Q2fXBbKhtsyhYrSLa7hXCNV+FdhbQhyrjks8Kic0u/U="</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span>

<span class="hljs-comment">&lt;!-- Compressed JavaScript --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/foundation-sites@6.6.3/dist/js/foundation.min.js"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha256-tdB5sxJ03S1jbwztV7NCvgqvMlVEvtcoJlgf62X49iM="</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span></code></pre></div><p>From Foundation 6.4, flex is enabled by default and <strong>only the new XY Grid is available</strong>. However, others CSS versions are available for backward compatibility and the most common usage cases. For others uses and advanced customization, we recommand to build Foundation with custom settings (see others installation methods).</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-comment">&lt;!-- foundation-float.min.css: Compressed CSS with legacy Float Grid --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">"stylesheet"</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/foundation-sites@6.6.3/dist/css/foundation-float.min.css"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha256-4ldVyEvC86/kae2IBWw+eJrTiwNEbUUTmN0zkP4luL4="</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span>

<span class="hljs-comment">&lt;!-- foundation-prototype.min.css: Compressed CSS with prototyping classes --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">"stylesheet"</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/foundation-sites@6.6.3/dist/css/foundation-prototype.min.css"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha256-WkUTcNCS9N9OXBuGE0w6uYBiFviiIsM5JJK6JCol8jQ="</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span>

<span class="hljs-comment">&lt;!-- foundation-rtl.min.css: Compressed CSS with right-to-left reading direction --&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">link</span> <span class="hljs-attr">rel</span>=<span class="hljs-string">"stylesheet"</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://cdn.jsdelivr.net/npm/foundation-sites@6.6.3/dist/css/foundation-rtl.min.css"</span> <span class="hljs-attr">integrity</span>=<span class="hljs-string">"sha256-wgkuX4RG+TO0/QoU8TisMBs4hRb6OnWZeIk30YpfWHE="</span> <span class="hljs-attr">crossorigin</span>=<span class="hljs-string">"anonymous"</span>&gt;</span></code></pre></div><div class="text-center">
...
<hr>
<h2 id="html-starter-template" class="docs-heading" data-magellan-target="html-starter-template">HTML Starter Template<a class="docs-heading-icon" href="#html-starter-template"></a></h2><p>Start with this HTML template and adapt it to your needs. Be sure to include the <code>.no-js</code> class on the <code>html</code> tag of your template.  Adding this class prevents <a href="https://en.wikipedia.org/wiki/Flash_of_unstyled_content">flash of unstyled content</a> for a number of foundation components.</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-meta">&lt;!doctype <span class="hljs-meta-keyword">html</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">html</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"no-js"</span> <span class="hljs-attr">lang</span>=<span class="hljs-string">"en"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">body</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/vendor/jquery.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/vendor/what-input.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"js/vendor/foundation.min.js"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Installation</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/installation.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BInstallation%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
