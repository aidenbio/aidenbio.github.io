...
<head>
  ...
  <title>Right-to-Left Support | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Right-to-Left Support</h1>
    ...
    <p class="docs-description lead">Foundation can easily adapt its components to work with languages that read from right to left.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="TPz2Uzr4urE"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=TPz2Uzr4urE"></a>
      </div>
    </div>
...
<p>View of a <a href="https://www.loc.gov/standards/iso639-2/php/code_list.php">full list of language codes</a> on the website of the Library of Congress.</p>
<hr>
<h2 id="css-download" class="docs-heading" data-magellan-target="css-download">CSS Download<a class="docs-heading-icon" href="#css-download"></a></h2><p>If you use a CSS version of Foundation (the ones you can find on the <a href="https://download.get.foundation/sites/download">download page</a>), you&#39;ll need to create a custom download that includes RTL CSS instead of LTR. Just select &quot;Right-to-left&quot; under the Text Direction section of the customizer.</p>
<hr>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Right-to-Left Support</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/rtl.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BRight-to-Left%20Support%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
