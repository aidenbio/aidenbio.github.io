...
<head>
  ...
  <title>Interchange | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="1Nr12_1rUpo"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=1Nr12_1rUpo"></a>
      </div>
    </div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/JNZQGB?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">img</span> <span class="hljs-attr">data-interchange</span>=<span class="hljs-string">"[assets/img/interchange/small.jpg, small], [assets/img/interchange/medium.jpg, medium], [assets/img/interchange/large.jpg, large]"</span>&gt;</span></code></pre></div><img data-interchange="[assets/img/interchange/small.jpg, small], [assets/img/interchange/medium.jpg, medium], [assets/img/interchange/large.jpg, large]">
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.interchange.js</code>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Type of the responsive ressource to replace. It can take the following options:
- `auto` (default): choose the type according to the element tag or the ressource extension,
- `src`: replace the `[src]` attribute, recommended for images `<img>`.
- `background`: replace the `background-image` CSS property.
- `html`: replace the element content.</td>
      </tr>
    </table>
  </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Interchange</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/interchange.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BInterchange%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
