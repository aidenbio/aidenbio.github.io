...
<head>
  ...
  <title>Responsive Navigation | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="dmKun75_9oc"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=dmKun75_9oc"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:58"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/qmYKgJ?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<ul>
<li><a href="#drilldown-dropdown-menu">Drilldown Dropdown Menu</a></li>
<li><a href="#accordion-dropdown-menu">Accordion Dropdown Menu</a></li>
<li><a href="#drilldown-accordion-menu">Drilldown Accordion Menu</a></li>
</ul>
<h4 id="drilldown-dropdown-menu" class="docs-heading">Drilldown Dropdown Menu<a class="docs-heading-icon" href="#drilldown-dropdown-menu"></a></h4><p>A drilldown menu works well on mobile, but on larger screens, you may want to convert that same menu into a dropdown. Here&#39;s an example that does just that:</p>
<p>
  <a class="" data-open-video="2:35"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/jmKPdM?editors=1010" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical medium-horizontal menu"</span> <span class="hljs-attr">data-responsive-menu</span>=<span class="hljs-string">"drilldown medium-dropdown"</span>&gt;</span>
...
<div class="docs-code-live"><ul class="vertical medium-horizontal menu" data-responsive-menu="drilldown medium-dropdown">
  <li>
    <a href="#">Item 1</a>
    <ul class="vertical menu">
      <li>
...
<div class="docs-code" data-docs-code><pre><code class="javascript"><span class="hljs-comment">// Patch for a Bug in v6.3.1</span>
$(<span class="hljs-built_in">window</span>).on(<span class="hljs-string">'changed.zf.mediaquery'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  $(<span class="hljs-string">'.is-dropdown-submenu.invisible'</span>).removeClass(<span class="hljs-string">'invisible'</span>);
});</code></pre></div><h4 id="accordion-dropdown-menu" class="docs-heading">Accordion Dropdown Menu<a class="docs-heading-icon" href="#accordion-dropdown-menu"></a></h4><p>Same like drilldowns, an accordion menu works well on mobile, but on larger screens, you may want to convert that same menu into a dropdown. Here&#39;s an example for the same:</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/LyXBQz?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical medium-horizontal menu"</span> <span class="hljs-attr">data-responsive-menu</span>=<span class="hljs-string">"accordion medium-dropdown"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Item 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
...
<div class="docs-code-live"><ul class="vertical medium-horizontal menu" data-responsive-menu="accordion medium-dropdown">
  <li>
    <a href="#">Item 1</a>
    <ul class="vertical menu">
      <li>
...
<h4 id="drilldown-accordion-menu" class="docs-heading">Drilldown Accordion Menu<a class="docs-heading-icon" href="#drilldown-accordion-menu"></a></h4><p>Just like foundation docs itself (see left sidenav), an accordion menu is great for a sidenav of a website on desktop, but for mobile, You might need Drilldown menu.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/bWQjQP?editors=1010" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu"</span> <span class="hljs-attr">data-responsive-menu</span>=<span class="hljs-string">"drilldown medium-accordion"</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"max-width: 250px;"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Item 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
...
<div class="docs-code-live"><ul class="vertical menu" data-responsive-menu="drilldown medium-accordion" style="max-width: 250px;">
  <li>
    <a href="#">Item 1</a>
    <ul class="vertical menu">
      <li>
...
<p><a class="" data-open-video="5:05"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<div class="primary callout show-for-medium">
  <p>Scale your browser down to see the toggle happen.</p>
</div>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/LymroM?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"title-bar"</span> <span class="hljs-attr">data-responsive-toggle</span>=<span class="hljs-string">"example-menu"</span> <span class="hljs-attr">data-hide-for</span>=<span class="hljs-string">"medium"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"menu-icon"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">data-toggle</span>=<span class="hljs-string">"example-menu"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
...
<h2 id="responsive-toggle-with-animation" class="docs-heading" data-magellan-target="responsive-toggle-with-animation">Responsive Toggle with animation<a class="docs-heading-icon" href="#responsive-toggle-with-animation"></a></h2><p>To use animations from the Motion UI library, include the <code>data-animate="someAnimationIn someAnimationOut"</code> attribute.</p>
<div class="primary callout show-for-medium">
  <p>Scale your browser down to see the toggle happen.</p>
</div>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/KmepBg?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"title-bar"</span> <span class="hljs-attr">data-responsive-toggle</span>=<span class="hljs-string">"example-animated-menu"</span> <span class="hljs-attr">data-hide-for</span>=<span class="hljs-string">"medium"</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"top-bar"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example-animated-menu"</span> <span class="hljs-attr">data-animate</span>=<span class="hljs-string">"hinge-in-from-top spin-out"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"top-bar-left"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"dropdown menu"</span> <span class="hljs-attr">data-dropdown-menu</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"menu-text"</span>&gt;</span>Site Title<span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
...
<div class="docs-code-live"><div class="title-bar" data-responsive-toggle="example-animated-menu" data-hide-for="medium">
...
<span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> (<span class="hljs-attribute">min-width:</span> <span class="hljs-number">40em</span>) {
...
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-selector-class">.no-js</span> {
  <span class="hljs-keyword">@include</span> breakpoint(small <span class="hljs-keyword">only</span>) {
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.responsiveMenu.js</code>
        ...
        <li>
          <code>foundation.responsiveToggle.js</code>
  ...
  <section>
    <h3 id="js-class" class="docs-heading">Foundation.ResponsiveMenu<a class="docs-heading-icon" href="#js-class"></a></h3>

    <p>Creates a new instance of a responsive menu.</p>


    <div class="docs-code"><pre><code><span class="hljs-keyword">var</span> elem = <span class="hljs-keyword">new</span> Foundation.ResponsiveMenu(element, options);</code></pre></div>

      <p><strong>Fires these events:</strong>
        ResponsiveMenu#event:init
      </p>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>To decide if the toggle should be animated or not.</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      <thead>
        ...
        <tr>
          <td><code>toggled.zf.responsiveToggle</code></td>
  ...
  <section>
    ...
    <section>
      ...
      <p>Destroys the instance of the current plugin on this element, as well as the window resize handler that switches the plugins out.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Responsive Navigation</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/responsive-navigation.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BResponsive%20Navigation%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
