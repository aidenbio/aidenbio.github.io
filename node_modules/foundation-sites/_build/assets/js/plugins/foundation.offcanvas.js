...
class OffCanvas extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_1__["Plugin"] {
  ...
  open(event, trigger) {
    ...
    this.$element.one(Object(_foundation_core_plugin__WEBPACK_IMPORTED_MODULE_1__["transitionend"])(this.$element), () => {
  ...
  close(cb) {
    ...
    this.$element.one(Object(_foundation_core_plugin__WEBPACK_IMPORTED_MODULE_1__["transitionend"])(this.$element), e => {
      this.$element.addClass('is-closed');
...
module.exports = __webpack_require__(/*! /home/samuel/Projects/aidenbio.github.io/node_modules/foundation-sites/js/entries/plugins/foundation.offcanvas.js */"./js/entries/plugins/foundation.offcanvas.js");
