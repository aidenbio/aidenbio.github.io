...
class AccordionMenu extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_4__["Plugin"] {
  ...
  down($target) {
    ...
    if (!this.options.multiOpen) {
      ...
      const $targetBranch = $target.parentsUntil(this.$element).add($target).add($target.find('.is-active')); // All the active submenus that are not in the branch.
...
class OffCanvas extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_1__["Plugin"] {
  ...
  _fixStickyElements() {
    this.$sticky.each((_, el) => {
      const $el = jquery__WEBPACK_IMPORTED_MODULE_0___default()(el); // If sticky element is currently fixed, adjust its top value to match absolute position due to transform scope
  ...
  _unfixStickyElements() {
    this.$sticky.each((_, el) => {
      ...
      let stickyData = $el.data('offCanvasSticky'); // If sticky element has got data object with prior values (meaning it was originally fixed) restore these values once off-canvas is closed
  ...
  close(cb) {
    ...
    this.$element.one(Object(_foundation_core_utils__WEBPACK_IMPORTED_MODULE_2__["transitionend"])(this.$element), e => {
      this.$element.addClass('is-closed');
  ...
  */
  ...
  _updateBullets(idx) {
    ...
    if (!activeStateDescriptor.length) {
      ...
      var spanCountInOthersBullets = $othersBullets.toArray().map(b => jquery__WEBPACK_IMPORTED_MODULE_0___default()(b).children('span').length); // If there is an exceeding span element, use it as current slide descriptor
...
class SmoothScroll extends _foundation_core_plugin__WEBPACK_IMPORTED_MODULE_2__["Plugin"] {
  ...
  static scrollToLoc(loc, options = SmoothScroll.defaults, callback) {
    const $loc = jquery__WEBPACK_IMPORTED_MODULE_0___default()(loc); // Do nothing if target does not exist to prevent errors
...
module.exports = __webpack_require__(/*! /home/samuel/Projects/aidenbio.github.io/node_modules/foundation-sites/js/entries/foundation.js */"./js/entries/foundation.js");
