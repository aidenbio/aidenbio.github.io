...
<head>
  ...
  <title>Tables | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Tables</h1>
    ...
    <p class="docs-description lead">Okay, they're not the sexiest things ever, but tables get the job done (for tabular data, of course). They have responsive modifiers to help solve some of your layout issues based on your tables needs.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="-Omv7c3Qg4s"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=-Omv7c3Qg4s"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:28"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/zwaazZ?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/xdzzgr?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<hr>
<h2 id="stripes" class="docs-heading" data-magellan-target="stripes">Stripes<a class="docs-heading-icon" href="#stripes"></a></h2><p>By default, table rows are striped. There&#39;s an <code>.unstriped</code> class to remove the stripes. If you change <code>$table-is-striped</code> to <code>false</code> to remove stripes from all tables, use the <code>.striped</code> class to add stripes.</p>
<p>
  <a class="" data-open-video="2:18"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/MmBQag?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">table</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"unstriped"</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">table</span>&gt;</span></code></pre></div><table class="unstriped">
  <thead>
    <tr>
      <th width="200">Table Header</th>
      <th>Table Header</th>
...
<p>
  <a class="" data-open-video="3:23"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/EmpQPK?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<p>
  <a class="" data-open-video="3:48"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/vmadKp?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>1px solid smart-scale($table-background, $table-color-scale)</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>rem-calc(8 10 10)</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>2%</code></td>
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>darken($table-background, $table-hover-scale)</code></td>
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>darken($table-background, $table-color-scale + $table-hover-scale)</code></td>
        <td><p>Default color of striped rows on hover.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$table-is-striped</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>true</code></td>
        <td><p>If <code>true</code>, tables are striped by default and an .unstriped class is created. If <code>false</code>, a .striped class is created.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$table-striped-background</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>smart-scale($table-background, $table-color-scale)</code></td>
      ...
      <tr>
        ...
        <td>Keyword</td>
        <td class="zf-docs-type-keyword"><code>even</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>smart-scale($table-background, $table-color-scale / 2)</code></td>
        <td><p>Default color for header background.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$table-head-row-hover</code></td>
        <td>List</td>
        <td class="zf-docs-type-list"><code>darken($table-head-background, $table-hover-scale)</code></td>
        <td><p>Default color of header rows on hover.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$table-foot-row-hover</code></td>
        <td>List</td>
        <td class="zf-docs-type-list"><code>darken($table-foot-background, $table-hover-scale)</code></td>
        <td><p>Default color of footer rows on hover.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$table-foot-font-color</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$body-font-color</code></td>
        <td><p>Default font color for footer.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$show-header-for-stacked</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>false</code></td>
        <td><p>Default value for showing the header when using stacked tables.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$table-stack-breakpoint</code></td>
        <td>Breakpoint</td>
        <td class="zf-docs-type-breakpoint"><code>medium</code></td>
        <td><p>Breakpoint at which stacked table switches from mobile to desktop view.</p>
</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <section >
      ...
      <div class="docs-code">
        <pre><code><span class="hljs-keyword">@include</span> table(<span class="hljs-variable">$stripe</span>, <span class="hljs-variable">$nest</span>);</code></pre>
      </div>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td><p>Needed if you only want to apply this to a specific table.</p>
</td>
        </tr>
      </table>
    </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Tables</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/table.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BTables%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
