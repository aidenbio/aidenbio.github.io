...
<head>
  ...
  <title>Media Queries | Foundation for Sites 6 Docs</title>
                  ...
                  <li class="accordion-item is-active" data-accordion-item>
                    ...
                    <div class="accordion-content is-active" data-tab-content>
                      <ul class="docs-nav-subcategory">
                        ...
                        <li class="current"><a href="media-queries.html">Media Queries</a> <span class="label">JS</span></li>
                      </ul>
                    </div>
                  </li>
...
<header>
  <h1 class="docs-page-title">Media Queries</h1>
    ...
    <p class="docs-description lead">CSS media queries allow us to adjust the display and orientation of content at different screen sizes.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="gqqi2cqlST8"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=gqqi2cqlST8"></a>
      </div>
    </div>
...
<li><strong>Medium:</strong> any screen 640 pixels or larger.</li>
<li><strong>Large:</strong> any screen 1024 pixels or larger.</li>
</ul>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-6 medium-4"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-6 medium-8"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
...
<span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> (<span class="hljs-attribute">max-width:</span> <span class="hljs-number">39.9375em</span>) {}
...
<span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> (<span class="hljs-attribute">min-width:</span> <span class="hljs-number">40em</span>) <span class="hljs-keyword">and</span> (<span class="hljs-attribute">max-width:</span> <span class="hljs-number">63.9375em</span>) {}

<span class="hljs-comment">/* Large and up */</span>
<span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> (<span class="hljs-attribute">min-width:</span> <span class="hljs-number">64em</span>) {}

<span class="hljs-comment">/* Large only */</span>
<span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> (<span class="hljs-attribute">min-width:</span> <span class="hljs-number">64em</span>) <span class="hljs-keyword">and</span> (<span class="hljs-attribute">max-width:</span> <span class="hljs-number">74.9375em</span>) {}</code></pre></div><hr>
...
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-keyword">@include</span> breakpoint(medium <span class="hljs-keyword">only</span>) {
}</code></pre></div><hr>
...
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-selector-class">.element</span> {
  ...
  <span class="hljs-keyword">@include</span> breakpoint(medium <span class="hljs-keyword">only</span>) { }
...
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> #{breakpoint(medium)} {
...
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-keyword">@media</span> screen <span class="hljs-keyword">and</span> #{breakpoint(medium)} and #{breakpoint(xlarge down)} {
...
<div class="docs-code" data-docs-code><pre><code class="js">Foundation.MediaQuery.current <span class="hljs-comment">// =&gt; 'small', 'medium', etc.</span></code></pre></div><p>You can use <code>MediaQuery.is()</code> to check the breakpoint the screen is at.</p>
<div class="docs-code" data-docs-code><pre><code class="js">Foundation.MediaQuery.is(<span class="hljs-string">'medium'</span>) <span class="hljs-comment">// =&gt; True for "medium" or larger</span></code></pre></div><p>You can also use the <code>up</code> (default), <code>only</code> and <code>down</code> modifiers like in Sass, or use the equivalent <code>MediaQuery.atLeast()</code>, <code>MediaQuery.only()</code> and <code>MediaQuery.upTo()</code>.</p>
<div class="docs-code" data-docs-code><pre><code class="js"><span class="hljs-comment">// ↑ True for "medium" or larger (by default)</span>
Foundation.MediaQuery.is(<span class="hljs-string">'medium up'</span>);
Foundation.MediaQuery.atLeast(<span class="hljs-string">'medium'</span>);

<span class="hljs-comment">// → True for "medium" only</span>
Foundation.MediaQuery.is(<span class="hljs-string">'medium only'</span>);
Foundation.MediaQuery.only(<span class="hljs-string">'medium'</span>);

<span class="hljs-comment">// ↓ True for "medium" or larger</span>
Foundation.MediaQuery.is(<span class="hljs-string">'medium down'</span>);
Foundation.MediaQuery.upTo(<span class="hljs-string">'medium'</span>);</code></pre></div><p>To get the media query of a breakpoint, use <code>MediaQuery.get</code>.</p>
...
<section>
  ...
  xxlarge: 1440px<br>
      ...
      <tr>
        <td class="name"><code>$breakpoints-hidpi</code></td>
        <td>Map</td>
        <td class="zf-docs-type-map"><code>
  hidpi-1: 1<br>
  hidpi-1-5: 1.5<br>
  ...
  hidpi-3: 3
        ...
        <td><p>A list of named HiDPI breakpoints. You can use these with the <code>breakpoint()</code> mixin to quickly create media queries for resolutions.
Values must represent the device pixels / web pixels ration and be unitless or in DPPX.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$print-breakpoint</code></td>
        <td>Keyword</td>
        <td class="zf-docs-type-keyword"><code>large</code></td>
        <td><p>The largest named breakpoint in which to include print as a media type</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$breakpoint-classes</code></td>
        <td>List</td>
        <td class="zf-docs-type-list"><code>small medium large</code></td>
  ...
  <section>
    ...
    <section >
      ...
      <div class="docs-code">
        <pre><code><span class="hljs-keyword">@include</span> breakpoint(<span class="hljs-variable">$values</span>...) { }</code></pre>
      </div>

      <p>Wraps a media query around the content you put inside the mixin. This mixin accepts a number of values:</p>
<ul>
<li>If a string is passed, the mixin will look for it in the <code>$breakpoints</code> and <code>$breakpoints-hidpi</code> maps, and use a media query there.</li>
...
<p>If multiple values are passed, the mixin will generate a media query for each of them as described above.
Since the content is duplicated for each breakpoint, this mixin should only be used with properties that
change across breakpoints.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td><p>Breakpoint name or px/rem/em value to process.</p>
</td>
        </tr>
      </table>
    </section>
...
<section>
  ...
  <section>
    ...
    <section>
      <h4 id="only" class="docs-heading">only<a class="docs-heading-icon" href="#only"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'only'</span>, size);</code></pre>
      </div>

      <p>Checks if the screen is within the given breakpoint.
If smaller than the breakpoint of larger than its upper limit it returns false.</p>
    ...
    <section>
      <h4 id="upto" class="docs-heading">upTo<a class="docs-heading-icon" href="#upto"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'upTo'</span>, size);</code></pre>
      </div>

      <p>Checks if the screen is within a breakpoint or smaller.</p>
    ...
    <section>
      <h4 id="is" class="docs-heading">is<a class="docs-heading-icon" href="#is"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'is'</span>, size);</code></pre>
      </div>

      <p>Checks if the screen matches to a breakpoint.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>size</code></td>
          <td>String</td>
          <td>Name of the breakpoint to check, either 'small only' or 'small'. Omitting 'only' falls back to using atLeast() method.</td>
        </tr>
      </table>
    ...
    <section>
      <h4 id="next" class="docs-heading">next<a class="docs-heading-icon" href="#next"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'next'</span>, size);</code></pre>
      </div>

      <p>Get the breakpoint following the given breakpoint.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Media Queries</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/media-queries.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BMedia%20Queries%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
