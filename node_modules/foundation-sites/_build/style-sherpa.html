...
<head>
  ...
  <title>Style Sherpa | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Style Sherpa</h1>
    ...
    <span data-tooltip title="This is an external library." class="docs-lib label"><a href="https://github.com/foundation/style-sherpa" target="_blank">Library</a></span>
    <p class="docs-description lead">Bundled with the ZURB Template, Style Sherpa makes it easy to create a style guide for your codebase, with just two files.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="paIqrjCm9_k"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=paIqrjCm9_k"></a>
      </div>
    </div>
...
<p><a href="https://github.com/foundation/style-sherpa">Style Sherpa</a> is a small tool bundled with the <a href="starter-projects.html#zurb-template">ZURB Template</a> that can generate a basic style guide for you quickly. The style guide is created from a single Markdown file, which contains all of the page content, and an HTML template, which defines the structure around the content.</p>
<hr>
<h2 id="usage" class="docs-heading" data-magellan-target="usage">Usage<a class="docs-heading-icon" href="#usage"></a></h2><p>
  <a class="" data-open-video="1:43"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<p>The ZURB Template includes the folder <code>src/styleguide/</code>, which contains both of the files you need to build your style guide. Like everything else in the ZURB Template, just edit the files and your changes will instantly be compiled</p>
...
<hr>
<h2 id="writing-content" class="docs-heading" data-magellan-target="writing-content">Writing Content<a class="docs-heading-icon" href="#writing-content"></a></h2><p>
  <a class="" data-open-video="5:09"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<p>The style guide is divided into sections. Generally, each component in your codebase&mdash;think buttons, panels, modals, form controls, and so on&mdash;will have its own section.</p>
...
Lorem ipsum dolor sit amet, <span class="hljs-code">`&lt;form&gt;`</span> elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</code></pre></div><h3 id="code-samples" class="docs-heading">Code Samples<a class="docs-heading-icon" href="#code-samples"></a></h3><p>
  <a class="" data-open-video="6:28"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<p>A style guide should always have HTML examples, which explain how to build something. To create a code block in Markdown, surround the code with three backticks. You can also set the language of the code block after the first set of backticks. Style Sherpa will color the syntax for you in the final output.</p>
...
<h2 id="changing-the-template" class="docs-heading" data-magellan-target="changing-the-template">Changing the Template<a class="docs-heading-icon" href="#changing-the-template"></a></h2><p>
  <a class="" data-open-video="3:32"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<p>The ZURB Template includes a minimal boilerplate for your style guide, but you&#39;re free to customize it however you want.</p>
...
<p></p>
<div class="docs-code" data-docs-code><pre><code class="handlebars"><span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"row"</span>&gt;</span>

  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"large-3 medium-4 columns"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">dl</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical tabs"</span> <span class="hljs-attr">data-tab</span>&gt;</span>
        ...
        <span class="hljs-tag">&lt;<span class="hljs-name">dd</span></span></span><span class="hljs-template-tag">{{#<span class="hljs-name"><span class="hljs-builtin-name">if</span></span> @first}}</span><span class="xml"><span class="hljs-tag"> <span class="hljs-attr">class</span>=<span class="hljs-string">"active"</span></span></span><span class="hljs-template-tag">{{/<span class="hljs-name"><span class="hljs-builtin-name">if</span></span>}}</span><span class="xml"><span class="hljs-tag">&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#</span></span></span><span class="hljs-template-variable">{{ anchor }}</span><span class="xml"><span class="hljs-tag"><span class="hljs-string">"</span>&gt;</span></span><span class="hljs-template-variable">{{ title }}</span><span class="xml"><span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">dd</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"large-9 medium-8 columns"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"tabs-content"</span>&gt;</span>
      </span><span class="hljs-template-tag">{{#<span class="hljs-name"><span class="hljs-builtin-name">each</span></span> pages}}</span><span class="xml">
        <span class="hljs-tag">&lt;<span class="hljs-name">section</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"content </span></span></span><span class="hljs-template-tag">{{#<span class="hljs-name"><span class="hljs-builtin-name">if</span></span> @first}}</span><span class="xml"><span class="hljs-tag"><span class="hljs-string">active</span></span></span><span class="hljs-template-tag">{{/<span class="hljs-name"><span class="hljs-builtin-name">if</span></span>}}</span><span class="xml"><span class="hljs-tag"><span class="hljs-string">"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"</span></span></span><span class="hljs-template-variable">{{ anchor }}</span><span class="xml"><span class="hljs-tag"><span class="hljs-string">"</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></span></code></pre></div><p>The template has access to a <code>pages</code> variable, which is an array with the data for each page. When looping through <code>pages</code> using <code>{{#each}}</code>, you have access to these variables:</p>
<ul>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Style Sherpa</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/style-sherpa.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/style-sherpa/issues" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
