...
<head>
  ...
  <title>Abide | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="4bN0qr5pxjs"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=4bN0qr5pxjs"></a>
      </div>
    </div>
...
<h2 id="abide-demo" class="docs-heading" data-magellan-target="abide-demo">Abide Demo<a class="docs-heading-icon" href="#abide-demo"></a></h2><p>These input types create a text field: <code>text</code>, <code>date</code>, <code>datetime</code>, <code>datetime-local</code>, <code>email</code>, <code>month</code>, <code>number</code>, <code>password</code>, <code>search</code>, <code>tel</code>, <code>time</code>, <code>url</code> and <code>week</code>. Note the use of the novalidate attribute to disable any browser validation that could conflict with Abide.</p>
<p>
  <a class="" data-open-video="0:27"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/brettsmason/pen/wdXRWP?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Number Required
          <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"1234"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example1Hint1"</span> <span class="hljs-attr">aria-errormessage</span>=<span class="hljs-string">"example1Error1"</span> <span class="hljs-attr">required</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"number"</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example1Hint1"</span>&gt;</span>Here's how you use this input field!<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Password Required
          <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"password"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"password"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"yeti4preZ"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example1Hint2"</span> <span class="hljs-attr">aria-errormessage</span>=<span class="hljs-string">"example1Error2"</span> <span class="hljs-attr">required</span> &gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span>&gt;</span>
            I'm required!
          <span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
        <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example1Hint2"</span>&gt;</span>Enter a password please.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Re-enter Password
          <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"password"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"yeti4preZ"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example1Hint3"</span> <span class="hljs-attr">aria-errormessage</span>=<span class="hljs-string">"example1Error3"</span> <span class="hljs-attr">required</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"alpha_numeric"</span> <span class="hljs-attr">data-equalto</span>=<span class="hljs-string">"password"</span>&gt;</span>
          <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span>&gt;</span>
            Hey, passwords are supposed to match!
          <span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
        <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example1Hint3"</span>&gt;</span>This field is using the `data-equalto="password"` attribute, causing it to match the password field above.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-container"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell large-6"</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell large-6"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Website Pattern, not required, but throws error if it doesn't match the Regular Expression for a valid URL or a Domain.
          <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"https://get.foundation or get.foundation"</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"website"</span>&gt;</span>
        <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
...
<hr>
<h3 id="form-errors" class="docs-heading">Form Errors<a class="docs-heading-icon" href="#form-errors"></a></h3><p>Abide automatically detects Form Errors of an input by their class (<code>.form-error</code> by default, see the <code>formErrorSelector</code> option) when they are siblings of the input or inside the same parent.</p>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span> <span class="hljs-attr">novalidate</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">data-abide-error</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"sr-only"</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"input-group"</span>&gt;</span>
      ...
      <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"input-group-field"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example3Input"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"number"</span> <span class="hljs-attr">required</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"number"</span>/&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span> <span class="hljs-attr">data-form-error-for</span>=<span class="hljs-string">"example3Input"</span>&gt;</span>Amount is required.<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
...
<div class="docs-code-live"><form data-abide novalidate>
  ...
  <button class="button" type="submit" value="Submit">Submit</button>
</form></div><p>You can specify validator-specific error messages using <code>[data-form-error-on]</code>
attribute, for example:</p>
<ul>
<li><code>data-form-error-on=&quot;required&quot;</code></li>
<li><code>data-form-error-on=&quot;pattern&quot;</code></li>
<li><code>data-form-error-on=&quot;equalTo&quot;</code></li>
<li><code>data-form-error-on=&quot;your_custom_validator&quot;</code></li>
</ul>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span> <span class="hljs-attr">novalidate</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Email Required
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">required</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"email"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span> <span class="hljs-attr">data-form-error-on</span>=<span class="hljs-string">"required"</span>&gt;</span>
      Yo, you had better fill this out, it's required.
    <span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span> <span class="hljs-attr">data-form-error-on</span>=<span class="hljs-string">"pattern"</span>&gt;</span>
      Invalid Email
    <span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"submit"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"Submit"</span>&gt;</span>Submit<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
...
<div class="docs-code-live"><form data-abide novalidate>
  ...
  <button class="button" type="submit" value="Submit">Submit</button>
</form></div><h2 id="initial-state" class="docs-heading" data-magellan-target="initial-state">Initial State<a class="docs-heading-icon" href="#initial-state"></a></h2><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- Add "display: none" right away --&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">data-abide-error</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"alert callout"</span> <span class="hljs-attr">aria-live</span>=<span class="hljs-string">"assertive"</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"display: none;"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fi-alert"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span> There are some errors in your form.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>
    Name
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example4Input"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example4Error"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">required</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example4Error"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error"</span>&gt;</span>This field is required.<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre></div><h2 id="error-state" class="docs-heading" data-magellan-target="error-state">Error State<a class="docs-heading-icon" href="#error-state"></a></h2><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">data-abide-error</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"alert callout"</span> <span class="hljs-attr">aria-live</span>=<span class="hljs-string">"assertive"</span> <span class="hljs-attr">role</span>=<span class="hljs-string">"alert"</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"display: block;"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">p</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fi-alert"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span> There are some errors in your form.<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"is-invalid-label"</span>&gt;</span>
    ...
    <span class="hljs-comment">&lt;!-- Add aria-invalid="true" --&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example4Input"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example4Error"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">required</span>
      <span class="hljs-attr">class</span>=<span class="hljs-string">"is-invalid-input"</span> <span class="hljs-attr">aria-invalid</span>=<span class="hljs-string">"true"</span>&gt;</span>
    <span class="hljs-comment">&lt;!-- Add "is-visible" --&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example4Error"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"form-error is-visible"</span>&gt;</span>This field is required.<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre></div><hr>
<h2 id="ignored-inputs" class="docs-heading" data-magellan-target="ignored-inputs">Ignored Inputs<a class="docs-heading-icon" href="#ignored-inputs"></a></h2><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Nothing Required!
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Use me, or don't"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example5Hint1"</span> <span class="hljs-attr">data-abide-ignore</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example5Hint1"</span>&gt;</span>This input is ignored by Abide using `data-abide-ignore`<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Disabled!
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Disabled input"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example5Hint2"</span> <span class="hljs-attr">disabled</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example5Hint2"</span>&gt;</span>This input is ignored by Abide using `disabled`<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">label</span>&gt;</span>Hidden!
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"hidden"</span> <span class="hljs-attr">placeholder</span>=<span class="hljs-string">"Hidden input"</span> <span class="hljs-attr">aria-describedby</span>=<span class="hljs-string">"example5Hint3"</span> &gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">p</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"help-text"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"example5Hint3"</span>&gt;</span>This input is ignored by Abide using `type="hidden"`<span class="hljs-tag">&lt;/<span class="hljs-name">p</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-container"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">fieldset</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"submit"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"Submit"</span>&gt;</span>Submit<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">fieldset</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">fieldset</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell small-12"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"reset"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"Reset"</span>&gt;</span>Reset<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
    ...
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre></div><h2 id="required-radio-checkbox" class="docs-heading" data-magellan-target="required-radio-checkbox">Required Radio &amp; Checkbox<a class="docs-heading-icon" href="#required-radio-checkbox"></a></h2><p>If you add <code>required</code> to a radio or checkbox input the whole group gets considered as required. This means at least one of the inputs must be checked.
Checkbox inputs support the additional attribute <code>data-min-required</code> what lets you specify how many checkboxes in the group must be checked (default is one).</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">form</span> <span class="hljs-attr">data-abide</span> <span class="hljs-attr">novalidate</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"grid-x grid-margin-x align-bottom"</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell medium-6 large-4"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">fieldset</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">legend</span>&gt;</span>Radio Group<span class="hljs-tag">&lt;/<span class="hljs-name">legend</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"radio"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleRadio"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleRadioA"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"A"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleRadioA"</span>&gt;</span>A<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">required</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"radio"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleRadio"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleRadioB"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"B"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleRadioB"</span>&gt;</span>B<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"radio"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleRadio"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleRadioC"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"C"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleRadioC"</span>&gt;</span>C<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">fieldset</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell medium-6 large-4"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">fieldset</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">legend</span>&gt;</span>Checkbox Group<span class="hljs-tag">&lt;/<span class="hljs-name">legend</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">data-min-required</span>=<span class="hljs-string">"2"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"checkbox"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleCheckbox"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleCheckboxA"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"A"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleCheckboxA"</span>&gt;</span>A<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">required</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"checkbox"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleCheckbox"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleCheckboxB"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"B"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleCheckboxB"</span>&gt;</span>B<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"checkbox"</span> <span class="hljs-attr">name</span>=<span class="hljs-string">"exampleCheckbox"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exampleCheckboxC"</span> <span class="hljs-attr">value</span>=<span class="hljs-string">"C"</span>&gt;</span>
        <span class="hljs-tag">&lt;<span class="hljs-name">label</span> <span class="hljs-attr">for</span>=<span class="hljs-string">"exampleCheckboxC"</span>&gt;</span>C<span class="hljs-tag">&lt;/<span class="hljs-name">label</span>&gt;</span>
      <span class="hljs-tag">&lt;/<span class="hljs-name">fieldset</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"cell large-4"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">button</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"button"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"submit"</span>&gt;</span>Submit<span class="hljs-tag">&lt;/<span class="hljs-name">button</span>&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">form</span>&gt;</span></code></pre></div>
...
<h2 id="event-listener" class="docs-heading" data-magellan-target="event-listener">Event Listener<a class="docs-heading-icon" href="#event-listener"></a></h2><p>Setup event listener after foundation is initialized (especially for formvalid/forminvalid). Easier to chain via document selector.</p>
<ul>
...
});</code></pre></div><h2 id="builtin-patterns-and-validators" class="docs-heading" data-magellan-target="builtin-patterns-and-validators">Builtin Patterns and Validators<a class="docs-heading-icon" href="#builtin-patterns-and-validators"></a></h2><p>The following patterns and validators are already built in:</p>
<p><code>alpha</code>,
...
<div class="docs-code" data-docs-code><pre><code class="JS">alpha : <span class="hljs-regexp">/^[a-zäöüßA-ZÄÖÜ]+$/</span>,
<span class="hljs-attr">alpha_numeric</span> : <span class="hljs-regexp">/^[a-zäöüßA-ZÄÖÜ0-9]+$/</span>,</code></pre></div><p>Then you need to customize the builtin patterns as explained in the next section. Otherwise Abide will produce an error if a special character is input in your text field which is validated with <code>pattern=&quot;alpha&quot;</code> or  <code>pattern=&quot;alpha_numeric&quot;</code>.</p>
<p>Here are the definitions of the builtin patterns:</p>
<div class="docs-code" data-docs-code><pre><code class="JS">alpha : <span class="hljs-regexp">/^[a-zA-Z]+$/</span>,
<span class="hljs-attr">alpha_numeric</span> : <span class="hljs-regexp">/^[a-zA-Z0-9]+$/</span>,
...
<span class="hljs-comment">// amex, visa, diners</span>
<span class="hljs-attr">card</span> : <span class="hljs-regexp">/^(?:4[0-9]{12}(?:[0-9]{3})?|5[1-5][0-9]{14}|6(?:011|5[0-9][0-9])[0-9]{12}|3[47][0-9]{13}|3(?:0[0-5]|[68][0-9])[0-9]{11}|(?:2131|1800|35\d{3})\d{11})$/</span>,
<span class="hljs-attr">cvv</span> : <span class="hljs-regexp">/^([0-9]){3,4}$/</span>,

<span class="hljs-comment">// https://www.whatwg.org/specs/web-apps/current-work/multipage/states-of-the-type-attribute.html#valid-e-mail-address</span>
...
<span class="hljs-comment">// From CommonRegexJS (@talyssonoc)</span>
<span class="hljs-comment">// https://github.com/talyssonoc/CommonRegexJS/blob/e2901b9f57222bc14069dc8f0598d5f412555411/lib/commonregex.js#L76</span>
<span class="hljs-comment">// For more restrictive URL Regexs, see https://mathiasbynens.be/demo/url-regex.</span>
<span class="hljs-attr">url</span>: <span class="hljs-regexp">/^((?:(https?|ftps?|file|ssh|sftp):\/\/|www\d{0,3}[.]|[a-z0-9.\-]+[.][a-z]{2,4}\/)(?:[^\s()&lt;&gt;]+|\((?:[^\s()&lt;&gt;]+|(?:\([^\s()&lt;&gt;]+\)))*\))+(?:\((?:[^\s()&lt;&gt;]+|(?:\([^\s()&lt;&gt;]+\)))*\)|[^\s`!()\[\]{};:\'".,&lt;&gt;?\xab\xbb\u201c\u201d\u2018\u2019]))$/</span>,

<span class="hljs-comment">// abc.de</span>
<span class="hljs-attr">domain</span> : <span class="hljs-regexp">/^([a-zA-Z0-9]([a-zA-Z0-9\-]{0,61}[a-zA-Z0-9])?\.)+[a-zA-Z]{2,8}$/</span>,

<span class="hljs-attr">datetime</span> : <span class="hljs-regexp">/^([0-2][0-9]{3})\-([0-1][0-9])\-([0-3][0-9])T([0-5][0-9])\:([0-5][0-9])\:([0-5][0-9])(Z|([\-\+]([0-1][0-9])\:00))$/</span>,
<span class="hljs-comment">// YYYY-MM-DD</span>
<span class="hljs-attr">date</span> : <span class="hljs-regexp">/(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))$/</span>,
<span class="hljs-comment">// HH:MM:SS</span>
<span class="hljs-attr">time</span> : <span class="hljs-regexp">/^(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}$/</span>,
<span class="hljs-attr">dateISO</span> : <span class="hljs-regexp">/^\d{4}[\/\-]\d{1,2}[\/\-]\d{1,2}$/</span>,
<span class="hljs-comment">// MM/DD/YYYY</span>
<span class="hljs-attr">month_day_year</span> : <span class="hljs-regexp">/^(0[1-9]|1[012])[- \/.](0[1-9]|[12][0-9]|3[01])[- \/.]\d{4}$/</span>,
<span class="hljs-comment">// DD/MM/YYYY</span>
<span class="hljs-attr">day_month_year</span> : <span class="hljs-regexp">/^(0[1-9]|[12][0-9]|3[01])[- \/.](0[1-9]|1[012])[- \/.]\d{4}$/</span>,

<span class="hljs-comment">// #FFF or #FFFFFF</span>
<span class="hljs-attr">color</span> : <span class="hljs-regexp">/^#?([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$/</span>,

<span class="hljs-comment">// Domain || URL</span>
<span class="hljs-attr">website</span>: {
  <span class="hljs-attr">test</span>: <span class="hljs-function">(<span class="hljs-params">text</span>) =&gt;</span> {
    <span class="hljs-keyword">return</span> Abide.defaults.patterns[<span class="hljs-string">'domain'</span>].test(text) || Abide.defaults.patterns[<span class="hljs-string">'url'</span>].test(text);
  }
...
<div class="docs-code" data-docs-code><pre><code class="javascript"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">myCustomValidator</span>(<span class="hljs-params">
  $el,      <span class="hljs-regexp">/* jQuery element to validate */</span>
  required, <span class="hljs-regexp">/* is the element required according to the `[required]` attribute */</span>
  parent    <span class="hljs-regexp">/* parent of the jQuery element `$el` */</span>
</span>) </span>{
...
Foundation.Abide.defaults.validators[<span class="hljs-string">'greater_than'</span>] = myCustomValidator;

<span class="hljs-comment">// Initialize Foundation</span>
$(<span class="hljs-built_in">document</span>).foundation();</code></pre></div><div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"phone"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"text"</span> <span class="hljs-attr">pattern</span>=<span class="hljs-string">"dashes_only"</span> <span class="hljs-attr">required</span> &gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">input</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"max"</span> <span class="hljs-attr">type</span>=<span class="hljs-string">"number"</span> <span class="hljs-attr">data-validator</span>=<span class="hljs-string">"greater_than"</span> <span class="hljs-attr">data-greater-than</span>=<span class="hljs-string">"min"</span> <span class="hljs-attr">required</span>&gt;</span></code></pre></div><h2 id="accessibility" class="docs-heading" data-magellan-target="accessibility">Accessibility<a class="docs-heading-icon" href="#accessibility"></a></h2><p>By default, Abide will add some accessibility attributes to your form elements. It is highly recommended to keep this option active as it improve the usability of your forms for disabled people. <a href="accessibility.html">Lean more about Accessibility in Foundation</a>.</p>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>get-color(alert)</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>rem-calc(12)</code></td>
      ...
      <tr>
        ...
        <td>Keyword</td>
        <td class="zf-docs-type-keyword"><code>$global-weight-bold</code></td>
  ...
  <section>
    ...
    <section >
      ...
      <div class="docs-code">
        <pre><code><span class="hljs-keyword">@include</span> form-input-error(<span class="hljs-variable">$background</span>, <span class="hljs-variable">$background-lighten</span>);</code></pre>
      </div>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>$background-lighten</code></td>
          <td>Number</td>
          <td><code>10%</code></td>
          <td><p>Lightness level of the background color.</p>
</td>
        </tr>
      </table>
    </section>
...
Remove or change this value for manual validation.</td>
      ...
      <tr>
        <td><code>data-a11y-attributes</code></td>
        <td><code>boolean</code></td>
        <td><code>true</code></td>
        <td>If true, automatically insert when possible:
- `[aria-describedby]` on fields
- `[role=alert]` on form errors and `[for]` on form error labels
- `[aria-live]` on global errors `[data-abide-error]` (see option `a11yErrorLevel`).</td>
      </tr>
      <tr>
        <td><code>data-a11y-error-level</code></td>
        <td><code>string</code></td>
        <td><code>assertive</code></td>
        <td>[aria-live] attribute value to be applied on global errors `[data-abide-error]`.
Options are: 'assertive', 'polite' and 'off'/null</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-validate-on-blur</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Set to true to validate inputs on blur.</td>
      </tr>
      <tr>
...
Trigger includes the element of the form.</td>
  ...
  <section>
    ...
    <section>
      <h4 id="enablevalidation" class="docs-heading">enableValidation<a class="docs-heading-icon" href="#enablevalidation"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'enableValidation'</span>);</code></pre>
      </div>

      <p>Enables the whole validation</p>
    ...
    <section>
      <h4 id="disablevalidation" class="docs-heading">disableValidation<a class="docs-heading-icon" href="#disablevalidation"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'disableValidation'</span>);</code></pre>
      </div>

      <p>Disables the whole validation</p>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'findFormError'</span>, $el, failedValidators);</code></pre>
      </div>

      <p>Get:</p>
<ul>
<li>Based on $el, the first element(s) corresponding to <code>formErrorSelector</code> in this order:<ol>
<li>The element&#39;s direct sibling(&#39;s).</li>
<li>The element&#39;s parent&#39;s children.</li>
</ol>
</li>
<li>Element(s) with the attribute <code>[data-form-error-for]</code> set with the element&#39;s id.</li>
</ul>
<p>This allows for multiple form errors per input, though if none are found, no form errors will be shown.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>failedValidators</code></td>
          <td>Array.<String></td>
          <td>List of failed validators.</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <p>Get the first element in this order:
2. The <label> with the attribute <code>[for=&quot;someInputId&quot;]</code>
3. The <code>.closest()</code> <label></p>
    ...
    <section>
      ...
      <p>Get the set of labels associated with a set of radio els in this order
2. The <label> with the attribute <code>[for=&quot;someInputId&quot;]</code>
3. The <code>.closest()</code> <label></p>
    ...
    <section>
      <h4 id="findcheckboxlabels" class="docs-heading">findCheckboxLabels<a class="docs-heading-icon" href="#findcheckboxlabels"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'findCheckboxLabels'</span>, $el);</code></pre>
      </div>

      <p>Get the set of labels associated with a set of checkbox els in this order
2. The <label> with the attribute <code>[for=&quot;someInputId&quot;]</code>
3. The <code>.closest()</code> <label></p>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'addErrorClasses'</span>, $el, failedValidators);</code></pre>
      </div>
    ...
    <section>
      <h4 id="adda11yattributes" class="docs-heading">addA11yAttributes<a class="docs-heading-icon" href="#adda11yattributes"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'addA11yAttributes'</span>, $el);</code></pre>
      </div>

      <p>Adds [for] and [role=alert] attributes to all form error targetting $el,
and [aria-describedby] attribute to $el toward the first form error.</p>
    ...
    <section>
      <h4 id="addglobalerrora11yattributes" class="docs-heading">addGlobalErrorA11yAttributes<a class="docs-heading-icon" href="#addglobalerrora11yattributes"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'addGlobalErrorA11yAttributes'</span>, $el);</code></pre>
      </div>

      <p>Adds [aria-live] attribute to the given global form error $el.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>$el</code></td>
          <td>Object</td>
          <td>jQuery object to add the attribute to</td>
        </tr>
      </table>
    ...
    <section>
      <h4 id="removecheckboxerrorclasses" class="docs-heading">removeCheckboxErrorClasses<a class="docs-heading-icon" href="#removecheckboxerrorclasses"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'removeCheckboxErrorClasses'</span>, groupName);</code></pre>
      </div>

      <p>Remove CSS error classes etc from an entire checkbox group</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>groupName</code></td>
          <td>String</td>
          <td>A string that specifies the name of a checkbox group</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <p>Goes through a form to find inputs and proceeds to validate them in ways specific to their type.
Ignores inputs with data-abide-ignore, type=&quot;hidden&quot; or disabled attributes set</p>
    ...
    <section>
      <h4 id="validatecheckbox" class="docs-heading">validateCheckbox<a class="docs-heading-icon" href="#validatecheckbox"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'validateCheckbox'</span>, groupName);</code></pre>
      </div>

      <p>Determines whether or a not a checkbox input is valid based on whether or not it is required and checked. Although the function targets a single <code>&lt;input&gt;</code>, it validates by checking the <code>required</code> and <code>checked</code> properties of all checkboxes in its group.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Abide</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/abide.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BAbide%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
