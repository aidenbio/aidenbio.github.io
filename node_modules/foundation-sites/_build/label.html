...
<head>
  ...
  <title>Label | Foundation for Sites 6 Docs</title>
...
<p>
  <a class="" data-open-video="3:52"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/pPKYVd?editors=1100" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-code-live"><span class="label">Default Label</span></div><br>
...
<h2 id="coloring" class="docs-heading" data-magellan-target="coloring">Coloring<a class="docs-heading-icon" href="#coloring"></a></h2><p>Add color classes to give labels additional meaning.</p>
<p>
  <a class="" data-open-video="4:04"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/rmKRJK?editors=1100" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label primary"</span>&gt;</span>Primary Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label secondary"</span>&gt;</span>Secondary Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label success"</span>&gt;</span>Success Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label alert"</span>&gt;</span>Alert Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label warning"</span>&gt;</span>Warning Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><span class="label primary">Primary Label</span>
<span class="label secondary">Secondary Label</span>
<span class="label success">Success Label</span>
<span class="label alert">Alert Label</span>
<span class="label warning">Warning Label</span></div><hr>
<h3 id="custom-colors" class="docs-heading">Custom Colors<a class="docs-heading-icon" href="#custom-colors"></a></h3><p>If you&#39;re using the Sass version of Foundation, you can customize the label classes by editing the <code>$label-palette</code> map in your settings file. The label palette defaults to <code>$foundation-palette</code>.</p>
<p>If you don&#39;t need certain colors from the default palette, simply remove them from the list.</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-variable">$label-palette</span>: map-remove(<span class="hljs-variable">$foundation-palette</span>, (
    primary,
    secondary
)) !default;</code></pre></div><p>Or you can add more colors to the default palette.</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-variable">$label-palette</span>: map-merge(<span class="hljs-variable">$foundation-palette</span>, (
    purple: <span class="hljs-number">#bb00ff</span>
)) !default;</code></pre></div><p>Or you can define your own custom label palette.</p>
<div class="docs-code" data-docs-code><pre><code class="scss"><span class="hljs-variable">$label-palette</span>: (
    black: <span class="hljs-number">#000000</span>,
    red: <span class="hljs-number">#ff0000</span>,
    purple: <span class="hljs-number">#bb00ff</span>
) !default;</code></pre></div><hr>
<h3 id="text-colors" class="docs-heading">Text Colors<a class="docs-heading-icon" href="#text-colors"></a></h3><p>The text color for each label class is determined by either <code>$label-color</code> or <code>$label-color-alt</code>, whichever settings variable has more contrast.</p>
...
<hr>
<h2 id="icons" class="docs-heading" data-magellan-target="icons">Icons<a class="docs-heading-icon" href="#icons"></a></h2><p>An icon can be dropped into a label just fine. We&#39;re using the <a href="https://zurb.com/playground/foundation-icon-fonts-3">Foundation icon font</a> here, but any icon fonts or image-based icons will work fine.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/dWKrgb?editors=1100" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label alert"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fi-x-circle"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span> Alert Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label warning"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fi-x"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span> Warning Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"label"</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">i</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"fi-widget"</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">i</span>&gt;</span> Default Label<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><span class="label alert"><i class="fi-x-circle"></i> Alert Label</span>
<span class="label warning"><i class="fi-x"></i> Warning Label</span>
<span class="label"><i class="fi-widget"></i> Default Label</span></div>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td class="name"><code>$label-color-alt</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$black</code></td>
        <td><p>Alternate text color for labels.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$label-palette</code></td>
        <td>Map</td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0.8rem</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0.33333rem 0.5rem</code></td>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Label</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/label.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BLabel%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
