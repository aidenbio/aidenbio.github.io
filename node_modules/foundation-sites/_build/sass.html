...
<head>
  ...
  <title>Sass | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Sass</h1>
    ...
    <p class="docs-description lead">Foundation is written in Sass, which allows us to make the codebase customizable and flexible.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="mYiyunVQdMY"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=mYiyunVQdMY"></a>
      </div>
    </div>
...
<h2 id="compatibility" class="docs-heading" data-magellan-target="compatibility">Compatibility<a class="docs-heading-icon" href="#compatibility"></a></h2><img src="assets/img/logos/sass-logo.svg" alt="Sass logo" class="float-right" style="width: 150px; height: 150px; margin-left: 1rem;">
...
<div class="docs-code" data-docs-code><pre><code class="js">autoprefixer({
  <span class="hljs-attr">browsers</span>: [<span class="hljs-string">'last 2 versions'</span>, <span class="hljs-string">'ie &gt;= 9'</span>, <span class="hljs-string">'android &gt;= 4.4'</span>, <span class="hljs-string">'ios &gt;= 7'</span>]
});</code></pre></div><hr>
<h2 id="loading-the-framework" class="docs-heading" data-magellan-target="loading-the-framework">Loading the Framework<a class="docs-heading-icon" href="#loading-the-framework"></a></h2><p>If you&#39;re using the CLI to create a project, the Sass compilation process is already set up for you. If not, you can compile our Sass files yourself, or drop in a pre-built CSS file.</p>
  ...
  <span class="hljs-attr">sass</span>: {
    <span class="hljs-attr">dist</span>: {
      <span class="hljs-attr">options</span>: {
        <span class="hljs-attr">loadPath</span>: [<span class="hljs-string">'node_modules/foundation-sites/scss'</span>]
      }
    }
  }
...
<span class="hljs-comment">// Grids (choose one)</span>
<span class="hljs-keyword">@include</span> foundation-xy-grid-classes;
<span class="hljs-comment">// @include foundation-grid;</span>
<span class="hljs-comment">// @include foundation-flex-grid;</span>

<span class="hljs-comment">// Generic components</span>
<span class="hljs-keyword">@include</span> foundation-button;
<span class="hljs-keyword">@include</span> foundation-button-group;
<span class="hljs-keyword">@include</span> foundation-close-button;
<span class="hljs-keyword">@include</span> foundation-label;
<span class="hljs-keyword">@include</span> foundation-progress-bar;
<span class="hljs-keyword">@include</span> foundation-slider;
<span class="hljs-keyword">@include</span> foundation-switch;
<span class="hljs-keyword">@include</span> foundation-table;
<span class="hljs-comment">// Basic components</span>
<span class="hljs-keyword">@include</span> foundation-badge;
<span class="hljs-keyword">@include</span> foundation-breadcrumbs;
<span class="hljs-keyword">@include</span> foundation-callout;
<span class="hljs-keyword">@include</span> foundation-card;
<span class="hljs-keyword">@include</span> foundation-dropdown;
<span class="hljs-keyword">@include</span> foundation-pagination;
<span class="hljs-keyword">@include</span> foundation-tooltip;

<span class="hljs-comment">// Containers</span>
<span class="hljs-keyword">@include</span> foundation-accordion;
<span class="hljs-keyword">@include</span> foundation-media-object;
<span class="hljs-keyword">@include</span> foundation-orbit;
<span class="hljs-keyword">@include</span> foundation-responsive-embed;
<span class="hljs-keyword">@include</span> foundation-tabs;
<span class="hljs-keyword">@include</span> foundation-thumbnail;
<span class="hljs-comment">// Menu-based containers</span>
<span class="hljs-keyword">@include</span> foundation-menu;
<span class="hljs-keyword">@include</span> foundation-menu-icon;
<span class="hljs-keyword">@include</span> foundation-accordion-menu;
<span class="hljs-keyword">@include</span> foundation-drilldown-menu;
<span class="hljs-keyword">@include</span> foundation-dropdown-menu;

<span class="hljs-comment">// Layout components</span>
<span class="hljs-keyword">@include</span> foundation-off-canvas;
<span class="hljs-keyword">@include</span> foundation-reveal;
<span class="hljs-keyword">@include</span> foundation-sticky;
<span class="hljs-keyword">@include</span> foundation-title-bar;
<span class="hljs-keyword">@include</span> foundation-top-bar;

<span class="hljs-comment">// Helpers</span>
<span class="hljs-keyword">@include</span> foundation-float-classes;
<span class="hljs-comment">// @include foundation-flex-classes;</span>
<span class="hljs-keyword">@include</span> foundation-visibility-classes;
<span class="hljs-comment">// @include foundation-prototype-classes;</span></code></pre></div><hr>
<h2 id="the-settings-file" class="docs-heading" data-magellan-target="the-settings-file">The Settings File<a class="docs-heading-icon" href="#the-settings-file"></a></h2><p>All Foundation projects include a settings file, named <code>_settings.scss</code>. If you&#39;re using the CLI to create a Foundation for Sites project, you can find the settings file under scss/ (basic template) or src/assets/scss/ (ZURB template). If you&#39;re installing the framework standalone using Bower or npm, there&#39;s a settings file included in those packages, which you can move into your own Sass files to work with.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    ...
    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/sass.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BSass%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
