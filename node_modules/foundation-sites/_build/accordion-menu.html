...
<head>
  ...
  <title>Accordion Menu | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="FXZIZ9N4aeI"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=FXZIZ9N4aeI"></a>
      </div>
    </div>
...
<p><a class="" data-open-video="1:03"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/qmKEQr?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu accordion-menu"</span> <span class="hljs-attr">data-accordion-menu</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><ul class="vertical menu accordion-menu" data-accordion-menu style="max-width: 250px">
  <li>
    <a href="#">Item 1</a>
...
<h2 id="submenu-toggle" class="docs-heading" data-magellan-target="submenu-toggle">Submenu Toggle<a class="docs-heading-icon" href="#submenu-toggle"></a></h2><p>Accordion menus can have a separate submenu toggle. This allows the parent item to have its own link, but still allows the submenu to be opened/closed.
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu accordion-menu"</span> <span class="hljs-attr">data-accordion-menu</span> <span class="hljs-attr">data-submenu-toggle</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"https://get.foundation/"</span> <span class="hljs-attr">target</span>=<span class="hljs-string">"_blank"</span>&gt;</span>Link here, dropdown there →<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"menu vertical nested"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><ul class="vertical menu accordion-menu" data-accordion-menu data-submenu-toggle="true" style="max-width: 300px">
  <li>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td class="name"><code>$accordionmenu-padding</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$global-menu-padding</code></td>
        <td><p>Sets accordion menu padding.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-nested-margin</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$global-menu-nested-margin</code></td>
        <td><p>Sets accordion menu nested margin</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-submenu-padding</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$accordionmenu-padding</code></td>
        <td><p>Sets accordion menu submenu padding.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$accordionmenu-item-background</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>null</code></td>
        <td><p>Sets accordion menu item padding.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-border</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>null</code></td>
        <td><p>Sets accordion menu item border.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-submenu-toggle-background</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>null</code></td>
        <td><p>Sets accordion menu item padding.</p>
</td>
      ...
      <tr>
        <td class="name"><code>$accordion-submenu-toggle-border</code></td>
        <td>List</td>
        <td class="zf-docs-type-list"><code>$accordionmenu-border</code></td>
        <td><p>Sets accordion menu item padding.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-submenu-toggle-width</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>40px</code></td>
        <td><p>Sets accordion menu submenu toggle background width.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-submenu-toggle-height</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$accordionmenu-submenu-toggle-width</code></td>
        <td><p>Sets accordion menu submenu toggle background height.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordionmenu-arrow-size</code></td>
        <td>Length</td>
        <td class="zf-docs-type-length"><code>6px</code></td>
        <td><p>Sets accordion menu arrow size if arrow is used.</p>
</td>
      </tr>
    </table>
  </section>
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.accordionMenu.js</code>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td><code>data-submenu-toggle</code></td>
        <td><code></code></td>
        <td><code></code></td>
        <td>Adds a separate submenu toggle button. This allows the parent item to have a link.</td>
      </tr>
      <tr>
        <td><code>data-submenu-toggle-text</code></td>
        <td><code></code></td>
        <td><code></code></td>
        <td>The text used for the submenu toggle if enabled. This is used for screen readers only.</td>
      </tr>
      <tr>
  ...
  <section>
    ...
    <section>
      <h4 id="showall" class="docs-heading">showAll<a class="docs-heading-icon" href="#showall"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'showAll'</span>);</code></pre>
      </div>

      <p>Opens all panes of the menu.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Accordion Menu</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/accordion-menu.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BAccordion%20Menu%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
