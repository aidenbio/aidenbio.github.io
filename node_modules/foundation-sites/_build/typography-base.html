...
<head>
  ...
  <title>Base Typography | Foundation for Sites 6 Docs</title>
...
<header>
  <h1 class="docs-page-title">Base Typography</h1>
    ...
    <p class="docs-description lead">Typography in Foundation 6 is meant to make your life easier by providing clean, attractive, simple default styles for all of the most basic typographical elements.</p>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="pzAyIfsXis4"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=pzAyIfsXis4"></a>
      </div>
    </div>
...
<a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/oWMEOd?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<p><a class="" data-open-video="0:25"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<div class="callout primary">
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/PmeKme" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<h3 id="header-styles" class="docs-heading">Header Styles<a class="docs-heading-icon" href="#header-styles"></a></h3><p>The framework includes two typographic scales&mdash;one uses a narrow range of sizes for small-sized screens, and the other uses a larger range of sizes for medium- and larger-sized screens. You can change these scales, or add new ones for other breakpoints, by editing the <code>$header-styles</code> map in your project&#39;s <a href="sass.html#the-settings-file">Settings File</a>.</p>
<p><a class="" data-open-video="1:28"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<table>
<thead>
<tr>
<th>Header</th>
...
<p>You can also adjust line height, margin top and margin bottom for each heading size by adding values in your <a href="sass.html#the-settings-file">Settings File</a>.</p>
<p>In its most complete form the <code>$header-styles</code> map looks like this:</p>
<div class="docs-code" data-docs-code><pre><code class="html">$header-styles: (
  'small': (
  ...
  ...
);</code></pre></div><p>Because this is a little bit lengthy we have also introduced a short form, that you can use alternatively:</p>
<div class="docs-code" data-docs-code><pre><code class="html">$header-styles: (
  'small': (
  ...
  ...
);</code></pre></div><p>The values for <code>&#39;font-size&#39;</code>/<code>&#39;fs&#39;</code>, <code>&#39;margin-top&#39;</code>/<code>&#39;mt&#39;</code> and <code>&#39;margin-bottom&#39;</code>/<code>&#39;mb&#39;</code> are transformed into &#39;rem&#39;s. You can use any unit, but if you don&#39;t, we assume that you mean &#39;px&#39;. If you do not set the keys <code>&#39;font-size&#39;</code>/<code>&#39;fs&#39;</code> defaults to <code>1rem</code>, <code>&#39;margin-top&#39;</code>/<code>&#39;mt&#39;</code> to <code>0</code> and <code>&#39;margin-bottom&#39;</code>/<code>&#39;mb&#39;</code> to <code>$header-margin-bottom</code> for size <code>&#39;small&#39;</code>. Thereafter the values for a larger size are inherited from the values of the smaller size if no value is entered for a larger breakpoint.</p>
<p>The value for <code>&#39;line-height&#39;</code>/<code>&#39;lh&#39;</code> is transformed into a unitless number, that expresses the line-height relative to the fonts-size. You can also input any unit. If you don&#39;t, we assume that for numbers smaller than or equal to 10, you mean a typical relative line-height. However, if you put in anything larger than 10, we assume you mean &#39;px&#39;, since we have not yet seen relative line-heights that were larger than 10. If you do not set <code>&#39;line-height&#39;</code>/<code>&#39;lh&#39;</code> it defaults to <code>$header-lineheight</code> for size <code>&#39;small&#39;</code>. Thereafter the value for a larger size is inherited from the values of the smaller size.</p>
...
<p>
  <a class="" data-open-video="2:46"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/eWrEEm" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">h3</span>&gt;</span>Foundation for Sites <span class="hljs-tag">&lt;<span class="hljs-name">small</span>&gt;</span>Version 6.6.1<span class="hljs-tag">&lt;/<span class="hljs-name">small</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">h3</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><h3>Foundation for Sites <small>Version 6.6.1</small></h3></div><hr>
...
<p><a class="" data-open-video="3:22"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<div class="callout">
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/wdjqrY" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/Vbxzrz" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/mmLMXx" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<h2 id="ordered-lists" class="docs-heading" data-magellan-target="ordered-lists">Ordered Lists<a class="docs-heading-icon" href="#ordered-lists"></a></h2><div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/XRqaBd" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/oWdeMe" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/ZKoJMb" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/jmpzNW?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<h2 id="code" class="docs-heading" data-magellan-target="code">Code<a class="docs-heading-icon" href="#code"></a></h2><p>Format references to code with the <code>&lt;code&gt;</code> tag. In order for angle brackets <code>&lt;&gt;</code> to render correctly, you need to change them to <code>&amp;lt; and &amp;gt;</code>.</p>
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/LymjvO" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html">Remember to escape angle brackets when printing HTML: <span class="hljs-tag">&lt;<span class="hljs-name">code</span>&gt;</span><span class="hljs-symbol">&amp;lt;</span>div<span class="hljs-symbol">&amp;gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">code</span>&gt;</span></code></pre></div>

<div class="docs-code-live">Remember to escape angle brackets when printing HTML: <code>&lt;div&gt;</code></div><hr>
<p>Use <code>.code-inline</code> component to apply the code style when you want.</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"code-inline"</span>&gt;</span>I am not code, but I am displayed as if.<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><span class="code-inline">I am not code, but I am displayed as if.</span></div><hr>
<p>Use the <code>.code-block</code> component to create a block of code.</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">code</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"code-block"</span>&gt;</span>{
...
<div class="docs-code-live"><code class="code-block">{
    "What I am": "I am a big chunk of code. I can have very long lines, I will not break and show a scrollbar instead.",
    ...
}</code></div><div class="callout info">
...
<div class="docs-codepen-container">
<a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/GmBxRL?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<h3 id="contrast" class="docs-heading">Contrast<a class="docs-heading-icon" href="#contrast"></a></h3><p>The contrast between the color of an element&#39;s text and its background should be high enough that low-vision users can read it. <strong>The minimum recommended contrast ratio is 4.5:1.</strong> There are no automated tools that can effectively check this for you, but if you aren&#39;t sure about a specific color combination, you can run it through one of many color contrast checkers, such as <a href="https://webaim.org/resources/contrastchecker/">WebAIM&#39;s color contrast checker</a>.</p>
...
<li><a href="https://webaim.org/techniques/fonts/">WebAIM: Fonts</a></li>
<li><a href="https://webaim.org/techniques/hypertext/">WebAIM: Links and HyperText</a></li>
<li><a href="https://webaim.org/techniques/semanticstructure/">WebAIM: Writing Clearly and Simply</a></li>
...
<p><a class="" data-open-video="4:42"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<div class="callout primary">
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td class="name"><code>$print-hrefs</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>true</code></td>
        <td><p>If <code>true</code>, displays next to all links their &quot;href&quot; when printed.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$header-font-family</code></td>
        <td>String or  List</td>
        <td class="zf-docs-type-string | list"><code>$body-font-family</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>$global-weight-normal</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>normal</code></td>
      ...
      <tr>
        ...
        <td>String or  List</td>
        <td class="zf-docs-type-string | list"><code>Consolas, &#x27;Liberation Mono&#x27;, Courier, monospace</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>inherit</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1.4</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0.5rem</code></td>
        <td><p>Bottom margin of headers.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$header-styles</code></td>
        <td>Map</td>
  ...
  medium: (
    ...
    &#x27;h6&#x27;: (&#x27;font-size&#x27;: 16)<br>
        ...
        <td><p>Styles for headings at various screen sizes. Each key is a breakpoint, and each value is a map of heading styles.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$header-text-rendering</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>optimizeLegibility</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>80%</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1.6</code></td>
      ...
      <tr>
        <td class="name"><code>$enable-code-inline</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>true</code></td>
        <td><p>Use the <code>.code-inline</code> component as default for <code>&lt;code&gt;</code> elements.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>scale-color($anchor-color, $lightness: -14%)</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>none</code></td>
        <td><p>Default text decoration for links.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="zf-docs-type-number | list"><code>rem-calc(20) auto</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$paragraph-lineheight</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$paragraph-margin-bottom</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>disc</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>outside</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1.25rem</code></td>
      ...
      <tr>
        ...
        <td>String</td>
        <td class="zf-docs-type-string"><code>$global-weight-bold</code></td>
      ...
      <tr>
        ...
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0.3rem</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$dark-gray</code></td>
      ...
      <tr>
        ...
        <td>Number or  List</td>
        <td class="zf-docs-type-number | list"><code>rem-calc(9 20 0 19)</code></td>
      ...
      <tr>
        <td class="name"><code>$enable-cite-block</code></td>
        <td>Boolean</td>
        <td class="zf-docs-type-boolean"><code>true</code></td>
        <td><p>Use the <code>.cite-block</code> component as default for <code>&lt;cite&gt;</code> elements.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$keystroke-font</code></td>
        <td>String or  List</td>
        <td class="zf-docs-type-string | list"><code>$font-family-monospace</code></td>
      ...
      <tr>
        ...
        <td>Number or  List</td>
        <td class="zf-docs-type-number | list"><code>rem-calc(2 4 0)</code></td>
      ...
      <tr>
        ...
        <td>Number or  List</td>
        <td class="zf-docs-type-number | list"><code>$global-radius</code></td>
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>1px dotted $black</code></td>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Base Typography</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/typography-base.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BBase%20Typography%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
