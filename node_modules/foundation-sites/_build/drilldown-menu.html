...
<head>
  ...
  <title>Drilldown Menu | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="8qPQRXl52hI"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=8qPQRXl52hI"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="0:54"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/JNZodd?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu drilldown"</span> <span class="hljs-attr">data-drilldown</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Two<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"menu vertical nested"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Two A<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Two B<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Two C<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Two D<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
...
<h2 id="autoheight" class="docs-heading" data-magellan-target="autoheight">autoHeight<a class="docs-heading-icon" href="#autoheight"></a></h2><div class="secondary callout">
...
<p>
<a class="" data-open-video="4:39"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/mmKyrw?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu drilldown"</span> <span class="hljs-attr">data-drilldown</span> <span class="hljs-attr">data-auto-height</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-animate-height</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!--  --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><ul class="vertical menu drilldown" data-drilldown data-auto-height="true" data-animate-height="true" style="max-width: 250px" id="m3">
  <li>
    <a href="#">Item 1</a>
    <ul class="menu vertical nested">
      <li>
...
<h2 id="scrolltop-drilldown" class="docs-heading" data-magellan-target="scrolltop-drilldown">ScrollTop Drilldown<a class="docs-heading-icon" href="#scrolltop-drilldown"></a></h2><div class="callout">Scroll to the top of the menu when selecting a submenu/navigating back using the menu back button. Can be useful with a longer menu to provide a better user experience.</div>


<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/jmKEwX?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu drilldown"</span> <span class="hljs-attr">data-drilldown</span> <span class="hljs-attr">data-scroll-top</span>=<span class="hljs-string">"true"</span>&gt;</span>
  <span class="hljs-comment">&lt;!--  --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><ul class="vertical menu drilldown" data-drilldown data-scroll-top="true" data-auto-height="true" data-animate-height="true" style="max-width: 250px" id="m2">
  <li><a href="#">Item</a></li>
  <li><a href="#">Item</a></li>
  <li><a href="#">Item</a></li>
  <li><a href="#">Item</a></li>
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.drilldown.js</code>

          <ul>
            <li>With utility library <code>foundation.util.keyboard.js</code></li>
            <li>With utility library <code>foundation.util.nest.js</code></li>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td><code>data-auto-apply-class</code></td>
        <td><code>boolean</code></td>
        <td><code>true</code></td>
        <td>Drilldowns depend on styles in order to function properly; in the default build of Foundation these are
on the `drilldown` class. This option auto-applies this class to the drilldown upon initialization.</td>
      </tr>
      <tr>
        <td><code>data-back-button</code></td>
        <td><code>string</code></td>
        <td><code>&amp;lt;li class&amp;#x3D;&amp;quot;js-drilldown-back&amp;quot;&amp;gt;&amp;lt;a tabindex&amp;#x3D;&amp;quot;0&amp;quot;&amp;gt;Back&amp;lt;/a&amp;gt;&amp;lt;/li&amp;gt;</code></td>
        <td>Markup used for JS generated back button. Prepended  or appended (see backButtonPosition) to submenu lists and deleted on `destroy` method, 'js-drilldown-back' class required. Remove the backslash (`\`) if copy and pasting.</td>
      </tr>
      <tr>
        <td><code>data-back-button-position</code></td>
        <td><code>string</code></td>
        <td><code>top</code></td>
        <td>Position the back button either at the top or bottom of drilldown submenus. Can be `'left'` or `'bottom'`.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-auto-height</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Allow the menu to auto adjust height.</td>
      </tr>
      <tr>
        <td><code>data-animate-height</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Animate the auto adjust height.</td>
      </tr>
      <tr>
        <td><code>data-scroll-top</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Scroll to the top of the menu after opening a submenu or navigating back using the menu back button</td>
      </tr>
      <tr>
        <td><code>data-scroll-top-element</code></td>
        <td><code>string</code></td>
        <td><code>&amp;#x27;&amp;#x27;</code></td>
        <td>String jquery selector (for example 'body') of element to take offset().top from, if empty string the drilldown menu offset().top is taken</td>
      </tr>
      <tr>
        <td><code>data-scroll-top-offset</code></td>
        <td><code>number</code></td>
        <td><code>0</code></td>
        <td>ScrollTop offset</td>
      </tr>
      <tr>
        <td><code>data-animation-duration</code></td>
        <td><code>number</code></td>
        <td><code>500</code></td>
        <td>Scroll animation duration</td>
      </tr>
      <tr>
        <td><code>data-animation-easing</code></td>
        <td><code>string</code></td>
        <td><code>swing</code></td>
        <td>Scroll animation easing. Can be `'swing'` or `'linear'`.</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      <thead>
        ...
        <tr>
          <td><code>scrollme.zf.drilldown</code></td>
          <td>Fires after the menu has scrolled</td>
        </tr>
        <tr>
          <td><code>close.zf.drilldown</code></td>
          <td>Fires when the menu is closing.</td>
        </tr>
        <tr>
          <td><code>closed.zf.drilldown</code></td>
          <td>Fires when the menu is fully closed.</td>
        </tr>
        <tr>
          <td><code>open.zf.drilldown</code></td>
          <td>Fires when the submenu has opened.</td>
        </tr>
        <tr>
          <td><code>hide.zf.drilldown</code></td>
  ...
  <section>
    ...
    <section>
      <h4 id="_scrolltop" class="docs-heading">_scrollTop<a class="docs-heading-icon" href="#_scrolltop"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_scrollTop'</span>);</code></pre>
      </div>

      <p>Scroll to Top of Element or data-scroll-top-element</p>


        <p><strong>Fires these events:</strong>
          Drilldown#event:scrollme
        </p>
    ...
    <section>
      <h4 id="_showmenu" class="docs-heading">_showMenu<a class="docs-heading-icon" href="#_showmenu"></a></h4>

      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'_showMenu'</span>, $elem, autoFocus);</code></pre>
      </div>

      <p>Opens a specific drilldown (sub)menu no matter which (sub)menu in it is currently visible.
Compared to _show() this lets you jump into any submenu without clicking through every submenu on the way to it.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>$elem</code></td>
          <td>jQuery</td>
          <td>the target (sub)menu (`ul` tag)</td>
        </tr>
        <tr>
          <td><code>autoFocus</code></td>
          <td>boolean</td>
          <td>if true the first link in the target (sub)menu gets auto focused</td>
        </tr>
      </table>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Drilldown Menu</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/drilldown-menu.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BDrilldown%20Menu%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
