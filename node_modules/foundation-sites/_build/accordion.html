...
<head>
  ...
  <title>Accordion | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="y_BX7saf65Q"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=y_BX7saf65Q"></a>
      </div>
    </div>
...
<p>
  <a class="" data-open-video="1:25"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/WjzKqa?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<p>
  <a class="" data-open-video="5:11"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/ybEErg?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<p>
  <a class="" data-open-video="6:09"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a>
</p>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/zwaaVp?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<hr>
<h3 id="disabled" class="docs-heading">Disabled<a class="docs-heading-icon" href="#disabled"></a></h3><p>There may be times where you want to disable pane switching on an accordion. This can be accomplished by setting the <code>disabled</code> option.</p>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion"</span> <span class="hljs-attr">data-accordion</span> <span class="hljs-attr">disabled</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item is-active"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 2, you can't open me.<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span>&gt;</span>
      Panel 2. Lorem ipsum dolor
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 3, you can't open me.<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span>&gt;</span>
      Panel 3. Lorem ipsum dolor
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
...
<div class="docs-code-live"><ul class="accordion" data-accordion disabled>
  <li class="accordion-item is-active" data-accordion-item>
    <a href="#" class="accordion-title">Accordion 1</a>
    <div class="accordion-content" data-tab-content>
      Panel 1. I'm open because I'm loaded that way, but you can't close me
...
<h2 id="accordion-and-urls" class="docs-heading" data-magellan-target="accordion-and-urls">Accordion and URLs<a class="docs-heading-icon" href="#accordion-and-urls"></a></h2><h3 id="browser-history" class="docs-heading">Browser history<a class="docs-heading-icon" href="#browser-history"></a></h3><p>When the <code>data-deep-link</code> option is set to <code>true</code>, the current state of the accordion is recorded by adding a hash with the accordion panel ID to the browser URL when a accordion opens. By default, accordion <em>replace</em> the browser history (using <code>history.replaceState()</code>). Modify this behavior by using attribute <code>data-update-history=&quot;true&quot;</code> to <em>append</em> to the browser history (using <code>history.pushState()</code>). In the latter case the browser back button will track each click that opens a accordion panel.</p>
<p>By using deep linking (see below), the open state of a page&#39;s tabset may be shared by copy-pasting the browser URL.</p>
<h3 id="deep-linking" class="docs-heading">Deep linking<a class="docs-heading-icon" href="#deep-linking"></a></h3><p>Add the attribute <code>data-deep-link=&quot;true&quot;</code> to a accordion to:</p>
<ul>
<li>modify the browser history when a accordion panel is clicked</li>
<li>allow users to open a particular accordion panel at page load with a hash-appended URL</li>
</ul>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion"</span> <span class="hljs-attr">data-accordion</span> <span class="hljs-attr">data-deep-link</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-update-history</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge-delay</span>=<span class="hljs-string">"500"</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplinked-accordion"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item is-active"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#deeplink1"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplink1"</span>&gt;</span>
      Panel 1. Lorem ipsum dolor
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#deeplink2"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 2<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplink2"</span>&gt;</span>
      Panel 2. Lorem ipsum dolor
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-item"</span> <span class="hljs-attr">data-accordion-item</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#deeplink3"</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-title"</span>&gt;</span>Accordion 3<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion-content"</span> <span class="hljs-attr">data-tab-content</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplink3"</span>&gt;</span>
      Panel 3. Lorem ipsum dolor
    <span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><ul class="accordion" data-accordion data-deep-link="true" data-update-history="true" data-deep-link-smudge="true" data-deep-link-smudge-delay="500" id="deeplinked-accordion">
  <li class="accordion-item is-active" data-accordion-item>
...
</ul></div><p>For example, <a target="_blank" href="#deeplink3">https://example.com/#deeplink3</a> will open the third accordion panel at page load. This example will open a new browser tab and scroll you to the open accordion panel.</p>
<p>When linking directly to a accordion panel, it might not be obvious that the content appears within a accordion panel. An additional attribute <code>data-deep-link-smudge</code> rolls the page up slightly after deep linking (to a horizontal accordion) so that the accordion is at the top of the viewport.</p>
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"accordion"</span> <span class="hljs-attr">data-deep-link</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge</span>=<span class="hljs-string">"true"</span> <span class="hljs-attr">data-deep-link-smudge-delay</span>=<span class="hljs-string">"600"</span> <span class="hljs-attr">data-accordion</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"deeplinked-accordion-with-smudge"</span>&gt;</span></code></pre></div>

<div class="docs-code-live"><ul class="accordion" data-deep-link="true" data-deep-link-smudge="true" data-deep-link-smudge-delay="600" data-accordion id="deeplinked-accordion-with-smudge"></div>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        <td class="name"><code>$accordion-plus-content</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>&#x27;\002B&#x27;</code></td>
        <td><p>Content for the plus icon when <code>$accordion-plusminus</code> is <code>true</code></p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordion-minus-content</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>&#x27;\2013&#x27;</code></td>
        <td><p>Content for the minus icon when <code>$accordion-plusminus</code> is <code>true</code></p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$accordion-title-font-size</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>rem-calc(12)</code></td>
        <td><p>Font size of accordion titles.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td class="zf-docs-type-number | list"><code>1.25rem 1rem</code></td>
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>1px solid $light-gray</code></td>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.accordion.js</code>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>Link the location hash to the open pane.
Set the location hash when the opened pane changes, and open and scroll to the corresponding pane when the location changes.</td>
      </tr>
      <tr>
        <td><code>data-deep-link-smudge</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>If `deepLink` is enabled, adjust the deep link scroll to make sure the top of the accordion panel is visible</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-deep-link-smudge-offset</code></td>
        <td><code>number</code></td>
        <td><code>0</code></td>
        <td>If `deepLinkSmudge` is enabled, the offset for scrollToTtop to prevent overlap by a sticky element at the top of the page</td>
      </tr>
      <tr>
        <td><code>data-update-history</code></td>
        <td><code>boolean</code></td>
        <td><code>false</code></td>
        <td>If `deepLink` is enabled, update the browser history with the open accordion</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      <thead>
        ...
        <tr>
          <td><code>deeplink.zf.accordion</code></td>
  ...
  <section>
    ...
    <section>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td>jQuery</td>
          <td>jQuery object of the pane to toggle (`.accordion-content`).</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>$target</code></td>
          <td>jQuery</td>
          <td>Accordion pane to open (`.accordion-content`).</td>
        </tr>
      </table>
    ...
    <section>
      ...
      <p>Closes the tab defined by <code>$target</code>.
It may be ignored if the Accordion options don&#39;t allow it.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          <td><code>$target</code></td>
          <td>jQuery</td>
          <td>Accordion tab to close (`.accordion-content`).</td>
        </tr>
      </table>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Accordion</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/accordion.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BAccordion%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
