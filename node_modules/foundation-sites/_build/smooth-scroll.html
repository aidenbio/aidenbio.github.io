...
<head>
  ...
  <meta name="description" content="Allows internal links smooth scrolling.">
  <link rel="icon" href="assets/img/icons/foundation-favicon.ico" type="image/x-icon">
  <title>Smooth Scroll | Foundation for Sites 6 Docs</title>
                  ...
                  <li class="accordion-item is-active" data-accordion-item>
                    ...
                    <div class="accordion-content is-active" data-tab-content>
                      <ul class="docs-nav-subcategory">
                        ...
                        <li class="current"><a href="smooth-scroll.html">Smooth Scroll <small>Navigation</small></a></li>
...
<article class="docs-component" id="docs-smooth-scroll">
...
<div>
<header>
  <h1 class="docs-page-title">Smooth Scroll</h1>
...
<h2 id="setup" class="docs-heading" data-magellan-target="setup">Setup<a class="docs-heading-icon" href="#setup"></a></h2><p>To enable SmoothScroll on internal links, just add the attribute <code>data-smooth-scroll</code> to the parent container like our <a href="menu.html">Menu</a>. Please note that each section needs a unique ID.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/jwOEEM?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"menu"</span> <span class="hljs-attr">data-smooth-scroll</span>&gt;</span>
...
<span class="hljs-tag">&lt;<span class="hljs-name">div</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"sections"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">section</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"first"</span>&gt;</span>First Section<span class="hljs-tag">&lt;/<span class="hljs-name">section</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">section</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"second"</span>&gt;</span>Second Section<span class="hljs-tag">&lt;/<span class="hljs-name">section</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">section</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"third"</span>&gt;</span>Third Section<span class="hljs-tag">&lt;/<span class="hljs-name">section</span>&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span></code></pre></div><p>You can also setup SmoothScroll directly via individual link.</p>
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/NgWPab?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>

<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#exclusive"</span> <span class="hljs-attr">data-smooth-scroll</span>&gt;</span>Exclusive Section<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
<span class="hljs-tag">&lt;<span class="hljs-name">section</span> <span class="hljs-attr">id</span>=<span class="hljs-string">"exclusive"</span>&gt;</span>The Exclusive Section<span class="hljs-tag">&lt;/<span class="hljs-name">section</span>&gt;</span></code></pre></div>
...
<section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.smoothScroll.js</code>
  ...
  <section>
    <h3 id="js-class" class="docs-heading">Foundation.SmoothScroll<a class="docs-heading-icon" href="#js-class"></a></h3>

    <p>Creates a new instance of SmoothScroll.</p>


    <div class="docs-code"><pre><code><span class="hljs-keyword">var</span> elem = <span class="hljs-keyword">new</span> Foundation.SmoothScroll(element, options);</code></pre></div>

      <p><strong>Fires these events:</strong>
        SmoothScroll#event:init
      </p>
  ...
  <section>
    ...
    <section>
      ...
      <div class="docs-code">
        <pre><code>$(<span class="hljs-string">'#element'</span>).foundation(<span class="hljs-string">'scrollToLoc'</span>, loc, options, callback);</code></pre>
      </div>
    ...
    <section>
      ...
      <p>Destroys the SmoothScroll instance.</p>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Smooth Scroll</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/smooth-scroll.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BSmooth%20Scroll%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
