...
<head>
  ...
  <title>Dropdown Menu | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="KfnRuKBKrbw"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=KfnRuKBKrbw"></a>
      </div>
    </div>
...
<p><a class="" data-open-video="0:53"><img src="assets/img/icons/watch-video-icon.svg" class="video-icon" height="30" width="30" alt=""> Watch this part in video</a></p>
<div class="primary callout">
  <p>Note that the <code>&lt;ul&gt;</code> goes <em>after</em> the <code>&lt;a&gt;</code>, and not inside of it.</p>
</div>

<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/XRYWPO?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/IamManchanda/pen/LyrYaE?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-code" data-docs-code><pre><code class="html"><span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical dropdown menu"</span> <span class="hljs-attr">data-dropdown-menu</span> <span class="hljs-attr">style</span>=<span class="hljs-string">"max-width: 250px;"</span>&gt;</span>
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Item 1<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">ul</span> <span class="hljs-attr">class</span>=<span class="hljs-string">"vertical menu nested"</span>&gt;</span>
      <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Item 1A<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
      <span class="hljs-comment">&lt;!-- ... --&gt;</span>
    <span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  ...
  <span class="hljs-tag">&lt;<span class="hljs-name">li</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">a</span> <span class="hljs-attr">href</span>=<span class="hljs-string">"#"</span>&gt;</span>Item 4<span class="hljs-tag">&lt;/<span class="hljs-name">a</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">li</span>&gt;</span>
  <span class="hljs-comment">&lt;!-- ... --&gt;</span>
<span class="hljs-tag">&lt;/<span class="hljs-name">ul</span>&gt;</span></code></pre></div><ul class="vertical dropdown menu" data-dropdown-menu style="max-width: 250px;">
  <li>
    <a href="#Item-1">Item 1</a>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Color</td>
        <td class="zf-docs-type-color"><code>$anchor-color</code></td>
        <td><p>Sets dropdown menu arrow color if arrow is used.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-arrow-size</code></td>
        <td>Length</td>
        <td class="zf-docs-type-length"><code>6px</code></td>
        <td><p>Sets dropdown menu arrow size if arrow is used.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-arrow-padding</code></td>
        <td>Length</td>
        <td class="zf-docs-type-length"><code>1.5rem</code></td>
        <td><p>Sets dropdown menu arrow padding for aligning the arrow correctly.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-min-width</code></td>
        <td>Length</td>
        <td class="zf-docs-type-length"><code>200px</code></td>
      ...
      <tr>
        ...
        <td><p>Background color for top level items.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-submenu-background</code></td>
        <td>Color</td>
      ...
      <tr>
        <td class="name"><code>$dropdownmenu-padding</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$global-menu-padding</code></td>
        <td><p>Padding for top level items.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-nested-margin</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>0</code></td>
        <td><p>Sets dropdown menu nested margin</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdownmenu-submenu-padding</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>$dropdownmenu-padding</code></td>
        <td><p>Padding for sub-menu items.</p>
</td>
      </tr>
      <tr>
      ...
      <tr>
        <td class="name"><code>$dropdown-menu-item-color-active</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>get-color(primary)</code></td>
        <td><p>Text color of an active dropdown menu item. Explicit override for menu defaults</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$dropdown-menu-item-background-active</code></td>
        <td>Color</td>
        <td class="zf-docs-type-color"><code>transparent</code></td>
        <td><p>Background color of an active dropdown menu item. Explicit override for menu defaults</p>
</td>
      </tr>
    </table>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      <ul>
        ...
        <li>
          <code>foundation.dropdownMenu.js</code>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>Position of the menu relative to what direction the submenus should open. Handled by JS. Can be `'auto'`, `'left'` or `'right'`.</td>
      </tr>
      <tr>
      ...
      <tr>
        <td><code>data-close-on-click-inside</code></td>
        <td><code>boolean</code></td>
        <td><code>true</code></td>
        <td>Allow clicks on leaf anchor links to close any open submenus.</td>
      </tr>
      <tr>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Dropdown Menu</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/dropdown-menu.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BDropdown%20Menu%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
