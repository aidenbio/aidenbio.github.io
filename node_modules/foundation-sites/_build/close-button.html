...
<head>
  ...
  <title>Close Button | Foundation for Sites 6 Docs</title>
  ...
  <div id="subpage-intro-video" class="subpage-intro-video">
    <div class="docs-video-inner autostick">
      ...
      <div class="responsive-embed widescreen">
        <div id="main-video" data-video="0cvJbo7ItpU"></div>
        <a id="docs-mobile-video-link" class="docs-mobile-video" target="_blank" href="https://www.youtube.com/watch?v=0cvJbo7ItpU"></a>
      </div>
    </div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ncoden/pen/vVrrjG?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<div class="docs-codepen-container">
  <a class="codepen-logo-link" href="https://codepen.io/ZURBFoundation/pen/JNvEox?editors=1000" target="_blank"><img src="assets/img/logos/edit-in-browser.svg" class="" height="" width="" alt="edit on codepen button"></a>
</div>
...
<section>
  ...
  <section>
    ...
    <table class="docs-variable-table">
      ...
      <tr>
        ...
        <td>List</td>
        <td class="zf-docs-type-list"><code>right top</code></td>
      ...
      <tr>
        <td class="name"><code>$closebutton-z-index</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>10</code></td>
        <td><p>Default z-index for a close button.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$closebutton-default-size</code></td>
        <td>String</td>
        <td class="zf-docs-type-string"><code>medium</code></td>
        <td><p>Button size to use as default</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$closebutton-offset-horizontal</code></td>
        <td>Number or Map</td>
        <td class="zf-docs-type-number|map"><code>
  small: 0.66rem<br>
  medium: 1rem<br>
</code></td>
        <td><p>Right (or left) offset(s) for a close button.</p>
</td>
      </tr>
      <tr>
  ...
  medium: 0.5rem<br>
        ...
        <td><p>Top (or bottom) offset(s) for a close button.</p>
</td>
      </tr>
      <tr>
  ...
  medium: 2em<br>
        ...
        <td><p>Size(s) of the close button. Used to generate sizing modifiers.</p>
</td>
      </tr>
      <tr>
        <td class="name"><code>$closebutton-lineheight</code></td>
        <td>Number</td>
        <td class="zf-docs-type-number"><code>1</code></td>
  ...
  <section>
    ...
    <section >
      <h4 id="close-button-size" class="docs-heading">close-button-size<a class="docs-heading-icon" href="#close-button-size"></a></h4>



      <div class="docs-code">
        <pre><code><span class="hljs-keyword">@include</span> close-button-size(<span class="hljs-variable">$size</span>);</code></pre>
      </div>

      <p>Sets the size and position of a close button.</p>
      ...
      <table class="docs-variable-table">
        ...
        <tr>
          ...
          <td><p>The size to use. Set to <code>small</code> to create a small close button. The &#39;medium&#39; values defined in <code>$closebutton-*</code> variables will be used as the default size and position of the close button.</p>
</td>
        </tr>
      </table>
    </section>
...
<nav class="docs-toc-wrap" id="docsToc" data-sticky-container>
  <div class="docs-toc hide" id="docsTOC" data-sticky data-margin-top="6" data-anchor="docs">
    <ul class="vertical menu" data-docs-toc data-magellan data-offset="130">
      <li class="docs-nav-title">Close Button</li>
    </ul>

    <hr class="docs-toc-divider small">

    <ul class="docs-contribute-menu">
      <li><a href="https://github.com/foundation/foundation-sites/edit/develop/docs/pages/close-button.md" target="_blank"><i class="fi-pencil"></i>Edit this Page</a></li>
      <li><a href="https://github.com/foundation/foundation-sites/issues/new?title=%5BClose%20Button%5D%20ISSUE%20NAME%20HERE" target="_blank"><i class="fi-social-github"></i>Report a Bug</a></li>
